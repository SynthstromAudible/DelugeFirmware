...
export const controlDescriptions: ControlDescriptions = {
  ...
  [Control.PARAMBUTTON1]: {
    title: "LEVEL/PAN BUTTON",
    type: ControlType.circleButton,
    classes: ["dc-level"],
  },
  [Control.PARAMBUTTON2]: {
    title: "CUTOFF/RES BUTTON",
    type: ControlType.circleButton,
    classes: ["dc-cutoff-fm"],
  },
  [Control.PARAMBUTTON3]: {
    title: "ATTACK/RELEASE BUTTON",
    type: ControlType.circleButton,
    classes: ["dc-attack"],
  },
  [Control.PARAMBUTTON4]: {
    title: "DELAY TIME/AMOUNT BUTTON",
    type: ControlType.circleButton,
    classes: ["dc-delay-time"],
  },
  [Control.PARAMBUTTON5]: {
    title: "SIDECHAIN/REVERB BUTTON",
    type: ControlType.circleButton,
    classes: ["dc-sidechain"],
  },
  [Control.PARAMBUTTON6]: {
    title: "MOD RATE/DEPTH BUTTON",
    type: ControlType.circleButton,
    classes: ["dc-mod-rate"],
  },
  [Control.PARAMBUTTON7]: {
    title: "STUTTER/CUSTOM 1 BUTTON",
    type: ControlType.circleButton,
    classes: ["dc-stutter"],
  },
  [Control.PARAMBUTTON8]: {
    title: "CUSTOM 2/3 BUTTON",
    type: ControlType.circleButton,
    classes: ["dc-custom2"],
  },
  [Control.PERFORMANCE]: {
