...
export const shortcutControlDescriptions: Record<Control, string> = {
  ...
  [Control.PARAMBUTTON]: "PARAM BUTTON",
  [Control.PARAMBUTTON1]: "LEVEL/PAN BUTTON",
  [Control.PARAMBUTTON2]: "CUTOFF/RES BUTTON",
  [Control.PARAMBUTTON3]: "ATTACK/RELEASE BUTTON",
  [Control.PARAMBUTTON4]: "DELAY TIME/AMOUNT BUTTON",
  [Control.PARAMBUTTON5]: "SIDECHAIN/REVERB BUTTON",
  [Control.PARAMBUTTON6]: "MOD RATE/DEPTH BUTTON",
  [Control.PARAMBUTTON7]: "STUTTER/CUSTOM 1 BUTTON",
  [Control.PARAMBUTTON8]: "CUSTOM 2/3 BUTTON",
