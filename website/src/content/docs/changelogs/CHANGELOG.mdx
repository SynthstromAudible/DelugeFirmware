...
- Added Community Feature toggle `Send MIDI CC on Clip / Section Launch (CCLN)` in `SETTINGS > COMMUNITY FEATURES`.
  - Default is `OFF`.
  - When `OFF`, MIDI clips do not send automated MIDI CC values on clip/section launch.
