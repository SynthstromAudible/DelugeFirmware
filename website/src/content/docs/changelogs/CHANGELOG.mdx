...
- Performance view layouts are now persisted to and loaded from your song file.
- Each song can now have a different performance view layout with different held pad settings.
