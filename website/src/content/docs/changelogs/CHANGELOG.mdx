...
<Aside type="tip">
  A new shortcuts page is available, check the [Deluge Companion](/reference/deluge_companion)!
</Aside>
...
- Added new learnable global commands:
  ...
  - `SHIFT` to toggle the deluge's `SHIFT` button. It can also be used to toggle sticky shift.
