...
- Main visualization modes: Waveform, Line Spectrum, Bar Spectrum, Cube, Stereo Line Spectrum, Starfield, Skyline, MIDI Piano Roll
- Additional special visualizers accessible via CV hotkey: Stereo Bar Spectrum, Tunnel, Pulse Grid
...
- **Clip-specific visualization**: Visualizer displays waveforms for individual instrument clips (Synth/Kit/Audio) when in clip view, keyboard screen, or holding clips in Session/Arranger views
