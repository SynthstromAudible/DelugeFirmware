...
<LinkButton icon="down-arrow" variant="secondary" href="#c120-chopin" iconPlacement="start">Jump to latest release</LinkButton>

<Aside>To find a detailed list of how to use each feature, check the [Feature Overview](/features/community_features)!</Aside>
