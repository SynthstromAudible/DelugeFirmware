...
### Converting DX7 Patch Banks **[1.4]**
...
1. Navigate to the DX7 SOURCE menu
...
- If a folder already exists for the .syx then the message ALREADY CONVERTED will show.
...
- A progress indicator shows while presets are being converted and a completion message shows how many presets were converted and how many were skipped

Note: When converting a .syx file, the final preset that was converted will remain loaded in a temporary slot. However, once you power the unit off and back on, that temporary preset is cleared just like any other unsaved instrument.
