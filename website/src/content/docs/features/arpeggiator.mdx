...
The arpeggiator was redesigned in <Badge text="c1.1" variant="tip" /> to have advanced features for the user like independent `OCTAVE MODE` and `NOTE MODE`, `RHYTHM`, `SEQUENCE LENGTH` and `RATCHETS` notes. It also enabled MPE keyboards to give more expression to the arpeggiated notes by updating live the velocity of the notes based on Aftertouch or MPE Y data coming from the keyboard.

In <Badge text="c1.3" variant="tip" />, the arpeggiator was redesigned again so it can be used on Synth clips, MIDI clips, CV clips, all types of Kit rows (Sound, MIDI and CV), and also to arpeggiate the entire Kit. Many new Arpeggiator parameters were also added which greatly improve the Arpeggiator's capabilities.

## Video Tutorials

<LinkPreviewCard
  youtubeId="VuAESUsW8bw"
  title="Chord Memory & Arpeggiator"
  description="Ron Cavagnaro"
/>
<LinkPreviewCard
  href="https://www.youtube.com/watch?v=gxnK2XJthYo&t=521"
  title="New Community Firmware Features: New Arp"
  description="Bay Mud"
/>
<LinkPreviewCard
  href="https://www.youtube.com/watch?v=pmDlRK_uzLE&t=940"
  title="Latest Community Firmware: Crazy Arpeggiator Updates"
  description="Mark Young"
/>

## Arpeggiator Modes (or Presets) <Badge text="c1.1 Feature" variant="tip" />

Arpeggiator Modes were used to set the arpeggiator to play in different ways. On the official firmware you were only able to select 4 modes. Now you can customize much more deeply the arpeggiator behaviour, with independent direction
...
- `Walk` will setup Mode to `Arpeggiator`, Octave Mode to `Alternate` and Note Mode to `Walk2`. <Badge text="c1.3 Feature" variant="tip" />
...
### Mode <Badge text="Official Feature" variant="tip" />
...
### Basic Parameters (BASI) <Badge text="Official Feature" variant="tip" />
...
### Pattern (PATT) <Badge text="c1.1 Feature" variant="tip" />
...
- **`Chord Simulator (CSIM)`** <Badge text="c1.3 Feature" variant="tip" />: is only available for Kit Rows. This allows you to simulate a chord so you
...
- **`Note Mode (NMOD)`**:
  ...
  - `Walk1 (WLK1)` <Badge text="c1.3 Feature" variant="tip" /> is the "slow" walk and next note is selected this way:
  ...
  - `Walk2 (WLK2)` <Badge text="c1.3 Feature" variant="tip" /> is the "normal" walk and next note is selected this way:
  ...
  - `Walk3 (WLK3)` <Badge text="c1.3 Feature" variant="tip" /> is the "fast" walk and next note is selected this way:
  ...
  - `Played Order (PLAY)` <Badge text="c1.3 Feature" variant="tip" /> will walk the notes in the same order that they were played. Tip: this mode
  ...
  - `Pattern (PATT)` <Badge text="c1.3 Feature" variant="tip" /> each time you select this `Note Mode` on the menu it will generate a new pattern for you.
    ...
    Note: this mode is not available for Kit Rows.
- **`Step Repeat (REPE)`** <Badge text="c1.3 Feature" variant="tip" />: allows you to set how many times the same note in the pattern is repeated
  before moving on to the next one.
- **`Rhythm (RHYT)`** <Badge text="c1.1 Feature" variant="tip" />: This parameter will play silences in some of the steps. This menu option shows zeroes and dashes,
...
- **`Sequence Length (LENG)`** <Badge text="c1.1 Feature" variant="tip" />: It defines the length of the pattern in number of steps.
...
### Randomizer (RAND) <Badge text="c1.3 Feature" variant="tip" />
...
- **`Ratchet Amount (RATC)`** <Badge text="c1.1 Feature" variant="tip" />: A ratchet is when a note repeats itself several times in the same time interval
...
- **`Ratchet Probability (RPRO)`** <Badge text="c1.1 Feature" variant="tip" />: This sets how likely a step is to be ratcheted. The ratchet amount is randomized on each step
...
### MPE <Badge text="c1.1 Feature" variant="tip" />
...
## Kit Arpeggiator <Badge text="c1.3 Feature" variant="tip" />
