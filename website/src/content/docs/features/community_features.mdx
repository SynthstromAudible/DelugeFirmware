...
- Horizontal Menu controls.
  ...
  - You can use the :key[SCALE] and :key[CROSSSCREEN] buttons to switch between pages or adjacent menus
    - Use :key[CROSSSCREEN] button to switch to the next page, or the next Horizontal menu if you're on the last page
    - Use :key[SCALE] button to switch to the previous page, or the previous Horizontal menu if you're on the first page
    - Use :key[SHIFT + CROSSSCREEN] button combo to switch straight to the next Horizontal menu
    - Use :key[SHIFT + SCALE] button combo to switch straight to the previous Horizontal menu
