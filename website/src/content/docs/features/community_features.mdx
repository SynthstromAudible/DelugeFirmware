...
- (#4526) <Badge text="c1.3" variant="tip" /> Add new default CC 122 to toggle the deluge's `SHIFT` button. CC 122 can be sent on any channel. It can also be used to toggle sticky shift.
  - Shift down: CC Value > 0 (Send a CC value greater than 0 to press shift)
  - Shift up: CC Value = 0 (Send a CC value of 0 to release shift)
