...
- Save and load defaults from Song file
...
#### 8) You can save and load Performance View layouts with your Song

Edit a performance view layout and save song to save performance view layout changes to the song.

The next time your song is loaded it will load the performance view layout changes saved to the song.

Held values are also saved to the song.
