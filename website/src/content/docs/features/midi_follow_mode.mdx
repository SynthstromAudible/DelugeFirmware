...
- <Badge text="c1.3" variant="tip" /> There are sixteen specific track MIDI follow channel's (Track1-16) which will always control the specific track configured.
...
- In the `MIDI-Follow > Channel` submenu, set the channel between 1 and 16 for Non-MPE or MPE Lower/Upper for MPE. 
  ...
  - <Badge text="c1.3" variant="tip" /> There are sixteen specific track channel's (1-16) available so that you can always control specific tracks (e.g. like a mixer)
    - These channels will always control the active clip of the specific track configured
