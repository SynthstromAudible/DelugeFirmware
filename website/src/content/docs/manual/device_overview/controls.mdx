...
#### Long-press to show popup menus

In the file browser, you can hold down the :key[Select] knob to open a popup menu. This enables you to do things like slicing samples, creating folders, and loading multiple samples into a kit.
...
When saving your song, you can save into a new folder by first typing the name for the folder and then long-pressing the :key[Select] knob to open the popup menu. From there, choose "CREAte folder". You can then type the name of your song and it will be saved into the new folder.
