## e2 Studio Software (Windows/Linux)
This guide is outdated as all current builds are done with the dbt included toolchain but might be helpful for very old commits
...
*(These instructions apply to the DelugeFirmware repository, which features many helpful configuration additions.)*
