...
> - **Arp** Rate, Gate, Spread Gate, Spread Octave, Spread Velocity, Ratchet Amount, Ratchet Probability, Chord Polyphony, Chord Probability, Note Probability, Bass Probability, Step Probability, Glide Probability, Reverse Probability, Rhythm, Sequence Length
> - **Noise** Level
> - **Portamento**
> - **Stutter** Rate
