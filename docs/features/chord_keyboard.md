...
Chords with accidentals in their names (like C-7♭5) will use a # or ♭ represenation in 7SEG, while the root note will use a . to represent the presense of the accidental. If Use Sharps(#) setting is selected F# #11 will be diplayed F.#11. If not Gb#11 will be displayed G.#11.
...
So for example, a C Major chord would be displayed as `CM`, a C Minor chord would be displayed as `C-`, and a C Diminished chord would be displayed as `CDIM`. A C Dominant 7 chord would be displayed as `C7`, a C Minor 7 Flat 5 chord would be displayed as `C-7♭5`.
