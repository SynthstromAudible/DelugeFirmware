# Deluge Community Firmware Directory Reference
...
| File | Relevance
|-|-
| [`main.c`](class_outlines/main_c.md) | all code starts here, in `main()`
| `definitions_cxx.hpp` | contains global definitions, used throughout the codebase

# Deluge Folder
`DelugeFirmware/src/deluge`

*Main directory for firmware code*

Important files:

| File | Relevance
|-|-
| [`deluge.cpp`](class_outlines/main_c.md) | `deluge_main()` is called from `main.c` and starts all repeating tasks
