...
- ([#1198] [#2990]) Added new features to the arpeggiator, which include:
    ...
    - **`Spread:`** There are three new parameters (unpatched, assignable to golden knobs), to control how the parameters
