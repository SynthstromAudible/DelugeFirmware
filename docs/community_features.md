...
LFO2 can be synchronized as well, using the labelled LFO2 sync pad. Whereas LFO1 synchronization is relative
to the grid, LFO2 synchronization is relative to individual notes. ([#1978])
