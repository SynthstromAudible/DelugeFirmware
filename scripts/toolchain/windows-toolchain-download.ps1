...
$toolchain_url = "https://github.com/litui/dbt-toolchain/releases/download/v$toolchain_version/dbt-toolchain-$toolchain_version-win32-x64.zip"
$toolchain_dist_folder = "win32-x64"
