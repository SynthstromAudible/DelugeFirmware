...
def generate(env):
    ...
    env.SetDefault(
        ...
        SELFUPDATE_SCRIPT="${DBT_SCRIPT_DIR}/selfupdate.py",
        DIST_SCRIPT="${DBT_SCRIPT_DIR}/sconsdist.py",
        COPRO_ASSETS_SCRIPT="${DBT_SCRIPT_DIR}/assets.py",
    )
