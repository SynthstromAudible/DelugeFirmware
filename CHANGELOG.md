...
- The arpeggiator has now a new `SPREAD` submenu with up to 4 parameters that will allow you to control how those parameters of each arp step are deviated from its base value.
