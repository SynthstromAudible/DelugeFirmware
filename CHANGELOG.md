...
#### <ins>MIDI_DEVICES SD card folder</ins>
- A new folder has been created in the root of the SD card titled `MIDI_DEVICES`
- The files `MIDIDevices.XML` and `MIDIFollow.XML` which were previously saved in the root of the SD card have been moved to the `MIDI_DEVICES` folder
