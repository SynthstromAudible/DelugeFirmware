...
public:
	...
	MIDIDevice* device;
	uint8_t channelOrZone; // In addition to being set to channel 0 to 15, can also be MIDI_CHANNEL_MPE_LOWER_ZONE or MIDI_CHANNEL_MPE_UPPER_ZONE
	uint8_t noteOrCC;
};
