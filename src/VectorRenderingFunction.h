...
#define waveRenderingFunctionGeneral() { \
	...
	waveRenderingFunctionGeneralForLoop(0) \
	waveRenderingFunctionGeneralForLoop(1) \
	waveRenderingFunctionGeneralForLoop(2) \
	waveRenderingFunctionGeneralForLoop(3) \
	\
...
#define waveRenderingFunctionPulse() { \
	...
	\
	/* Need to use a macro rather than a for loop here, otherwise won't compile with less than O2. */ \
	waveRenderingFunctionPulseForLoop(0) \
	waveRenderingFunctionPulseForLoop(1) \
	waveRenderingFunctionPulseForLoop(2) \
