...
public:
	MenuItemPatchedParamInteger(char const* newName = NULL, int newP = 0) : MenuItemPatchedParam(newP), MenuItemIntegerContinuous(newName) {}
#if !HAVE_OLED
...
public:
	MenuItemSourceDependentPatchedParam(char const* newName = 0, int newP = 0) : MenuItemPatchedParamInteger(newName, newP) {}
	uint8_t getP();
};
