...
/// in flight or queued are deduplicated to avoid redundant full-frame transfers. CV words don't go
/// through here — they preempt via the priority slot in oled_low_level.c.
