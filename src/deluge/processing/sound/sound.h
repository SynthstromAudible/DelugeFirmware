...
public:
	...
	void writeToFile(StorageManager &bdsm, bool savingSong, ParamManager* paramManager, ArpeggiatorSettings* arpSettings);
...
private:
	...
	Error readSourceFromFile(StorageManager &bdsm, int32_t s, ParamManagerForTimeline* paramManager, int32_t readAutomationUpToPos);
