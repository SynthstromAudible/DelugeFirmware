...
void SoundInstrument::offerReceivedYamahaSysex(MIDIDevice* fromDevice, int32_t channel, uint8_t* data, int32_t len) {
...
void SoundInstrument::receivedYamahaSysex(MIDIDevice* fromDevice, MIDIMatchType match, int32_t channel, uint8_t* data,
                                          int32_t len) {
