...
public:
	...
	void setTextWithMultipleDots(std::string_view newText, bool alignRight = false,
	                             std::vector<uint8_t> dotPositions = {}, bool doBlink = false,
	                             uint8_t* newBlinkMask = nullptr, bool blinkImmediately = false) override;
