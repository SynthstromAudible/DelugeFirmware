...
enum class String : size_t {
    ...
    */
	...
	STRING_FOR_PRE_DELAY,
	STRING_FOR_INPUT_DIFFUSION,
	STRING_FOR_INPUT_LPF_CUTOFF,
	STRING_FOR_INPUT_HPF_CUTOFF,
	STRING_FOR_MOD_DEPTH,
	STRING_FOR_MOD_SHAPE,
	STRING_FOR_MOD_SPEED,
	STRING_FOR_LPF_CUTOFF,
	STRING_FOR_HPF_CUTOFF,
