...
enum class String : size_t {
	...
	STRING_FOR_COMMUNITY_FEATURE_PINGPONG_STUTTER,
	...
	STRING_FOR_ARP_SPREAD_LOCK_TITLE,
	...
	STRING_FOR_ARP_CHORD_TYPE_MENU_TITLE,
