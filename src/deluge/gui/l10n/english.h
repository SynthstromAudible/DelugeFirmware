...
constexpr Language english{
    "English",
    {
        ...
        {STRING_FOR_NORMAL_DELAY, "Normal delay"},
        {STRING_FOR_PINGPONG_DELAY, "Ping-pong delay"},
        ...
        {STRING_FOR_SYNC_TYPE_TRIPLET, "Triplet"},
        {STRING_FOR_SYNC_TYPE_DOTTED, "Dotted"},
        {STRING_FOR_SYNC_TYPE_EVEN, "Even"},
        {STRING_FOR_SYNC_LEVEL_WHOLE, "1-bar"},
        {STRING_FOR_SYNC_LEVEL_2ND, "2nd"},
        {STRING_FOR_SYNC_LEVEL_4TH, "4th"},
        {STRING_FOR_SYNC_LEVEL_8TH, "8th"},
        {STRING_FOR_SYNC_LEVEL_16TH, "16th"},
        {STRING_FOR_SYNC_LEVEL_32ND, "32nd"},
        {STRING_FOR_SYNC_LEVEL_64TH, "64th"},
        {STRING_FOR_SYNC_LEVEL_128TH, "128th"},
        {STRING_FOR_SYNC_LEVEL_256TH, "256th"},
