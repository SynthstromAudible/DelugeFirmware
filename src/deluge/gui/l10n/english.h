...
constexpr Language english{
    "English",
    {
        ...
        {STRING_FOR_MODFX_TYPE, "MODFX type"},
        {STRING_FOR_MODFX_RATE, "MODFX rate"},
        {STRING_FOR_FEEDBACK, "FEEDBACK"},
        {STRING_FOR_MODFX_FEEDBACK, "MODFX feedback"},
        {STRING_FOR_MODFX_DEPTH, "MODFX depth"},
        {STRING_FOR_OFFSET, "OFFSET"},
        {STRING_FOR_MODFX_OFFSET, "MODFX offset"},
