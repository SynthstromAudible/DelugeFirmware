...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_DEFAULT_UI_DEFAULT_STARTUP_SONG_MODE, "STSONG"},
        {STRING_FOR_DEFAULT_UI_DEFAULT_STARTUP_SONG_MODE_BLANK, "NSONG"},
        {STRING_FOR_DEFAULT_UI_DEFAULT_STARTUP_SONG_MODE_TEMPLATE, "TEMPL"},
        {STRING_FOR_DEFAULT_UI_DEFAULT_STARTUP_SONG_MODE_LAST_OPENED, "LASTO"},
        {STRING_FOR_DEFAULT_UI_DEFAULT_STARTUP_SONG_MODE_LAST_SAVED, "LASTS"},
        {STRING_FOR_INPUT, "IN"},
