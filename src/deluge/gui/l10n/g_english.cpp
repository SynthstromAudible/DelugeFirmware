...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_CHORD_ROW_MODE, "Chord Row Mode"},
        {STRING_FOR_CHORD_COLUMN_MODE, "Chord Column Mode"},
        {STRING_FOR_MODWHEEL, "Modwheel"},
        {STRING_FOR_CHORD, "Chord"},
        {STRING_FOR_SONG_CHORD_MEMORY, "Song Chord Memory"},
        {STRING_FOR_CLIP_CHORD_MEMORY, "Clip Chord Memory"},
        {STRING_FOR_DX_OPERATORS, "DX operators"},
        {STRING_FOR_SONG_MACROS, "Song macros"},
        {STRING_FOR_BEAT_REPEAT, "Beat repeat"},
    },
};
} // namespace deluge::l10n::built_in
// clang-format on
