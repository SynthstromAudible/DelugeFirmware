...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_DEFAULT_UI_AUTOMATION_INTERPOLATION, "Interpolation"},
        {STRING_FOR_DEFAULT_UI_AUTOMATION_CLEAR, "Clear"},
        {STRING_FOR_DEFAULT_UI_AUTOMATION_NUDGE_NOTE, "Nudge Note"},
        {STRING_FOR_DEFAULT_UI_AUTOMATION_SHIFT, "Shift"},
        {STRING_FOR_DEFAULT_UI_AUTOMATION_DISABLE_AUDITION_PAD_SHORTCUTS, "Disable Audition Pad Shortcuts"},
        {STRING_FOR_DEFAULT_UI_PERFORMANCE_GOLD_KNOB_VALUE_EDITING, "Gold Knob Value Editing"},
        ...
        {STRING_FOR_PERFORMANCE, "Performance"},
