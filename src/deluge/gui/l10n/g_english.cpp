...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_DEFAULT_UI_KEYBOARD_LAYOUT_PIANO, "Piano"},
        ...
        {STRING_FOR_ARP_SPREAD_LOCK_TITLE, "Arp spread lock"},
        ...
        {STRING_FOR_ARP_CHORD_TYPE_MENU_TITLE, "Arp chord type"},
        ...
        {STRING_FOR_ARP_BASS_CHANCE_MENU_TITLE, "Arp bass chance"},
        {STRING_FOR_ARP_RATCHET_PROBABILITY_MENU_TITLE, "Arp ratc prob"},
        {STRING_FOR_ARP_SEQUENCE_LENGTH_MENU_TITLE, "Arp seq length"},
        {STRING_FOR_ARP_SPREAD_VELOCITY_MENU_TITLE, "Arp spread velo"},
        {STRING_FOR_ARP_SPREAD_GATE_MENU_TITLE, "Arp spread gate"},
        {STRING_FOR_ARP_SPREAD_OCTAVE_MENU_TITLE, "Arp spread oct"},
