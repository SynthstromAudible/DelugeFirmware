...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_BASS_FREQUENCY_SHORT, "Bfreq"},
        {STRING_FOR_TREBLE, "TREBLE"},
        {STRING_FOR_TREBLE_FREQUENCY, "Treble frequency"},
        {STRING_FOR_TREBLE_FREQUENCY_SHORT, "Tfreq"},
        ...
        {STRING_FOR_UNISON_NUMBER_SHORT, "Number"},
        {STRING_FOR_UNISON_DETUNE, "Unison detune"},
        {STRING_FOR_UNISON_DETUNE_SHORT, "Detune"},
        {STRING_FOR_UNISON_STEREO_SPREAD, "Unison stereo spread"},
        {STRING_FOR_UNISON_STEREO_SPREAD_SHORT, "Spread"},
