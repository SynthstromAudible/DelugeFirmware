...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_SONG_MACRO_TYPE_CLIP, "Type: Clip"},
        {STRING_FOR_SONG_MACRO_TYPE_OUTPUT, "Type: Output"},
        {STRING_FOR_SONG_MACRO_TYPE_SECTION, "Type: Section"},
        {STRING_FOR_SONG_MACRO_TYPE_NONE, "Type: None"},
