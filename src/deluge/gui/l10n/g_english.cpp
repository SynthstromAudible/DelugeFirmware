...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_INPUT_UNPITCHED, "Input Unpitched"},
        {STRING_FOR_INPUT_LEFT_UNPITCHED, "Input (left) Unpitched"},
        {STRING_FOR_INPUT_RIGHT_UNPITCHED, "Input (right) Unpitched"},
        {STRING_FOR_INPUT_STEREO_UNPITCHED, "Input (stereo) Unpitched"},
