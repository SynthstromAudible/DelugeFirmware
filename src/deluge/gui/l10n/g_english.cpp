...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_BASS_FREQUENCY, "B.FQ"},
        {STRING_FOR_TREBLE, "TREBLE"},
        {STRING_FOR_TREBLE_FREQUENCY, "T.FQ"},
        ...
        {STRING_FOR_SVF_BAND, "Bandpass SVF"},
        {STRING_FOR_SVF_NOTCH, "Notch SVF"},
        {STRING_FOR_HPLADDER, "HP Ladder"},
        {STRING_FOR_HPLADDER_SHORT, "12DB"},
        ...
        {STRING_FOR_SAMPLE_1, "Sample 1"},
        {STRING_FOR_SAMPLE_2, "Sample 2"},
        {STRING_FOR_NUMBER, "Number"},
        {STRING_FOR_DETUNE, "Detune"},
        {STRING_FOR_SPREAD, "Spread"},
        ...
        {STRING_FOR_RATCHETS, "Ratchets"},
        {STRING_FOR_PROBABILITY, "Probability"},
        ...
        {STRING_FOR_REVERB_SIDECHAIN, "SDCH"},
        ...
        {STRING_FOR_FEEDBACK, "FBCK"},
        {STRING_FOR_OFFSET, "OFFS"},
        {STRING_FOR_EQ, "EQ"},
        ...
        {STRING_FOR_LPF, "LPF"},
        {STRING_FOR_LOW_PASS_FILTER, "Low-Pass Filter"},
        {STRING_FOR_HIGH_PASS_FILTER, "High-Pass Filter"},
        ...
        {STRING_FOR_ENV0_ATTACK, "Env1 attack"},
        {STRING_FOR_ENV0_DECAY, "Env1 decay"},
        {STRING_FOR_ENV0_SUSTAIN, "Env1 sustain"},
        {STRING_FOR_ENV0_RELEASE, "Env1 release"},
        {STRING_FOR_ENV1_ATTACK, "Env2 attack"},
        {STRING_FOR_ENV1_DECAY, "Env2 decay"},
        {STRING_FOR_ENV1_SUSTAIN, "Env2 sustain"},
        {STRING_FOR_ENV1_RELEASE, "Env2 release"},
        ...
        {STRING_FOR_MIXER, "Mixer"},
        {STRING_FOR_RANGE, "Range"},
        {STRING_FOR_OSC1, "OSC1"},
        {STRING_FOR_OSC2, "OSC2"},
        {STRING_FOR_PW, "PW"},
        {STRING_FOR_PHASE, "PHASE"},
