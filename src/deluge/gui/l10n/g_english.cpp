...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_CLIP_TYPE, "CLIP TYPE"},
        {STRING_FOR_PIANO_ROLL, "PIANO ROLL"},
        {STRING_FOR_STEP_SEQ, "STEP SEQ"},
        {STRING_FOR_PULSE_SEQ, "PULSE SEQ"},
        ...
        {STRING_FOR_LANES_SEQ, "LANES"},
        {STRING_FOR_LANES_LANE, "Lane"},
        {STRING_FOR_LANES_LANE_TITLE, "Lane Editor"},
