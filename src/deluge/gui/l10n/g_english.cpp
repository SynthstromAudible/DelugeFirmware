...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_MIDI_HARMONIZER, "MIDI Harmonizer"},
        ...
        {STRING_FOR_HARMONIZER, "Harmonizer"},
        {STRING_FOR_HARMONIZER_BASIC_MENU_TITLE, "Harmonizer Basic"},
        {STRING_FOR_HARMONIZER_MODE_MENU_TITLE, "Harmonizer Mode"},
        {STRING_FOR_HARMONIZER_TIGHTNESS, "Tightness"},
        {STRING_FOR_HARMONIZER_TIGHTNESS_MENU_TITLE, "Harmonizer Tightness"},
        {STRING_FOR_HARMONIZER_VOICE_LEADING, "Voice Lead"},
        {STRING_FOR_HARMONIZER_VOICE_LEADING_MENU_TITLE, "Voice Leading"},
        {STRING_FOR_HARMONIZER_TRANSPOSE_MENU_TITLE, "Harmonizer Transpose"},
        {STRING_FOR_HARMONIZER_RETRIGGER, "Retrigger"},
        {STRING_FOR_HARMONIZER_RETRIGGER_MENU_TITLE, "Harmonizer Retrigger"},
        {STRING_FOR_HARMONIZER_CHORD_CH, "Chord Ch"},
        {STRING_FOR_HARMONIZER_CHORD_CH_MENU_TITLE, "Chord Channel"},
        {STRING_FOR_HARMONIZER_NEAREST, "Nearest"},
        {STRING_FOR_HARMONIZER_ROUND_DOWN, "Round Down"},
        {STRING_FOR_HARMONIZER_ROUND_UP, "Round Up"},
        {STRING_FOR_HARMONIZER_STRICT, "Strict"},
        {STRING_FOR_HARMONIZER_LOOSE, "Loose"},
        {STRING_FOR_HARMONIZER_ROOT, "Root"},
        {STRING_FOR_HARMONIZER_ROOT_5TH, "Root+5th"},
        {STRING_FOR_HARMONIZER_EXTENSIONS, "Extensions"},
        {STRING_FOR_HARMONIZER_HARMONY_MENU_TITLE, "Harmonizer Harmony"},
        {STRING_FOR_HARMONIZER_INTERVAL, "Interval"},
        {STRING_FOR_HARMONIZER_INTERVAL_MENU_TITLE, "Diatonic Interval"},
        {STRING_FOR_HARMONIZER_INT_OFF, "Off"},
        {STRING_FOR_HARMONIZER_INT_3RD_ABOVE, "3rd Above"},
        ...
        {STRING_FOR_HARMONIZER_SNAP_MENU_TITLE, "Harmonizer Snap"},
        {STRING_FOR_HARMONIZER_TARGET, "Target"},
        {STRING_FOR_HARMONIZER_TARGET_MENU_TITLE, "Harmonizer Target"},
        {STRING_FOR_HARMONIZER_TARGET_CHORD_TONES, "Chord Tones"},
        {STRING_FOR_HARMONIZER_INTERVAL_VELOCITY, "Int. Vel"},
        {STRING_FOR_HARMONIZER_INTERVAL_VELOCITY_MENU_TITLE, "Interval Velocity"},
        {STRING_FOR_HARMONIZER_PROBABILITY, "Prob"},
        {STRING_FOR_HARMONIZER_PROBABILITY_MENU_TITLE, "Harmonizer Probability"},
        {STRING_FOR_HARMONIZER_LATCH, "Latch"},
        {STRING_FOR_HARMONIZER_LATCH_MENU_TITLE, "Chord Latch"},
    },
};
} // namespace deluge::l10n::built_in
// clang-format on
