...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_GRAIN_SIZE, "Grain Size"},
        {STRING_FOR_GRAIN_TYPE, "Grain Type"},
        {STRING_FOR_GRAIN_AMOUNT, "Grain Amount"},
        ...
        {STRING_FOR_CONFIGURE_EXPORT_STEMS_ARRANGEMENT, "Export Arrangement"},
