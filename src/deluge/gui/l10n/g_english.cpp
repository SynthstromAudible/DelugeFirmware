...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_NOTE_PROBABILITY, "Note Chance"},
        ...
        {STRING_FOR_BASS_PROBABILITY, "Bass Chance"},
        {STRING_FOR_CHORD_POLYPHONY, "Chord Polyphony"},
        {STRING_FOR_CHORD_PROBABILITY, "Chord Chance"},
        {STRING_FOR_RATCHET_PROBABILITY, "Ratchet Chance"},
        ...
        {STRING_FOR_ARP_RANDOMIZER_LOCK_TITLE, "Arp rand lock"},
