...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_TRANSPORT_OUT, "Transport Out"},
        {STRING_FOR_TRANSPORT_IN, "Transport In"},
        ...
        {STRING_FOR_MIDI_TRANSPORT_OUT, "MIDI transport out"},
        {STRING_FOR_MIDI_TRANSPORT_IN, "MIDI transport in"},
