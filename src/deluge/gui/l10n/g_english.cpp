...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_METRONOME_FOLLOW, "Metro Follow Clip"},
        ...
        {STRING_FOR_TEMPO_RATIO_NUMERATOR, "Numerator"},
        {STRING_FOR_TEMPO_RATIO_DENOMINATOR, "Denominator"},
        {STRING_FOR_CUSTOM_RATIO, "Custom"},
        ...
        {STRING_FOR_TIME_SIGNATURE, "Time Signature"},
        {STRING_FOR_TIME_SIG_NUMERATOR, "Beats Per Bar"},
        {STRING_FOR_TIME_SIG_DENOMINATOR, "Beat Unit"},
