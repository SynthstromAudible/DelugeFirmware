...
constexpr Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_NORMAL_DELAY, "NORM"},
        {STRING_FOR_PINGPONG_DELAY, "PING-PONG"},
        ...
        {STRING_FOR_SYNC_TYPE_TRIPLET, "TPLT"},
        {STRING_FOR_SYNC_TYPE_DOTTED, "DOTT"},
        {STRING_FOR_SYNC_TYPE_EVEN, "EVEN"},
        {STRING_FOR_SYNC_LEVEL_WHOLE, "1BAR"},
