...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_DEFAULT_UI_KB_CONTROLS, "Column controls"},
        {STRING_FOR_DEFAULT_UI_KB_CONTROLS_VELOCITY_GLIDE, "Velocity Glide"},
        {STRING_FOR_DEFAULT_UI_KB_CONTROLS_MODWHEEL_GLIDE, "Modwheel Glide"},
