...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_DEFAULT_UI_FUNCTIONS, "Functions"},
        {STRING_FOR_DEFAULT_UI_FUNCTIONS_VELOCITY_GLIDE, "Velocity Glide"},
        {STRING_FOR_DEFAULT_UI_FUNCTIONS_MODWHEEL_GLIDE, "Modwheel Glide"},
