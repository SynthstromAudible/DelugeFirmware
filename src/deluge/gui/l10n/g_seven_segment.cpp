...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_PATTERN_SAVED, "SAVE"},
        {STRING_FOR_PATTERN_LOADED, "LOAD"},
        {STRING_FOR_PATTERN_NOSCALING, "NOSC"},
        {STRING_FOR_PATTERN_NOOVERWRITE, "NOOW"},
        {STRING_FOR_PATTERN_NODRUM, "NODR"},
        {STRING_FOR_PATTERN_PREVIEW, "PREV"},
