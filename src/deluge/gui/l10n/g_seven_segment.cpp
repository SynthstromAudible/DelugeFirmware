...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_DEFAULT_UI_AUTOMATION_INTERPOLATION, "INTE"},
        {STRING_FOR_DEFAULT_UI_AUTOMATION_CLEAR, "CLEA"},
        {STRING_FOR_DEFAULT_UI_AUTOMATION_NUDGE_NOTE, "NUDG"},
        {STRING_FOR_DEFAULT_UI_AUTOMATION_SHIFT, "SHIF"},
        {STRING_FOR_DEFAULT_UI_AUTOMATION_DISABLE_AUDITION_PAD_SHORTCUTS, "SCUT"},
        {STRING_FOR_DEFAULT_UI_PERFORMANCE_GOLD_KNOB_VALUE_EDITING, "GOLD"},
