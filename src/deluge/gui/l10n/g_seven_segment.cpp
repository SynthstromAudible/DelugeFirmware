...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_MIDI_HARMONIZER, "HARM"},
        ...
        {STRING_FOR_HARMONIZER, "HARM"},
        {STRING_FOR_HARMONIZER_BASIC_MENU_TITLE, "BASI"},
        {STRING_FOR_HARMONIZER_MODE_MENU_TITLE, "MODE"},
        {STRING_FOR_HARMONIZER_TIGHTNESS, "TITE"},
        {STRING_FOR_HARMONIZER_TIGHTNESS_MENU_TITLE, "TITE"},
        {STRING_FOR_HARMONIZER_VOICE_LEADING, "VLAD"},
        {STRING_FOR_HARMONIZER_VOICE_LEADING_MENU_TITLE, "VLAD"},
        {STRING_FOR_HARMONIZER_TRANSPOSE_MENU_TITLE, "TRNS"},
        {STRING_FOR_HARMONIZER_RETRIGGER, "RTRG"},
        {STRING_FOR_HARMONIZER_RETRIGGER_MENU_TITLE, "RTRG"},
        {STRING_FOR_HARMONIZER_CHORD_CH, "CHCH"},
        {STRING_FOR_HARMONIZER_CHORD_CH_MENU_TITLE, "CHCH"},
        {STRING_FOR_HARMONIZER_NEAREST, "NEAR"},
        {STRING_FOR_HARMONIZER_ROUND_DOWN, "RDDN"},
        {STRING_FOR_HARMONIZER_ROUND_UP, "RDUP"},
        {STRING_FOR_HARMONIZER_STRICT, "STRC"},
        {STRING_FOR_HARMONIZER_LOOSE, "LOOS"},
        {STRING_FOR_HARMONIZER_ROOT, "ROOT"},
        {STRING_FOR_HARMONIZER_ROOT_5TH, "RT5T"},
        {STRING_FOR_HARMONIZER_EXTENSIONS, "EXTN"},
        {STRING_FOR_HARMONIZER_HARMONY_MENU_TITLE, "HARM"},
        {STRING_FOR_HARMONIZER_INTERVAL, "INTV"},
        {STRING_FOR_HARMONIZER_INTERVAL_MENU_TITLE, "INTV"},
        {STRING_FOR_HARMONIZER_INT_OFF, "OFF"},
        {STRING_FOR_HARMONIZER_INT_3RD_ABOVE, "3RAB"},
        {STRING_FOR_HARMONIZER_INT_3RD_BELOW, "3RBL"},
        {STRING_FOR_HARMONIZER_INT_6TH_ABOVE, "6TAB"},
        {STRING_FOR_HARMONIZER_INT_6TH_BELOW, "6TBL"},
                {STRING_FOR_HARMONIZER_INT_OCTAVE, "OCTV"},
        {STRING_FOR_HARMONIZER_MAPPING_MENU_TITLE, "MAP"},
        {STRING_FOR_HARMONIZER_VOICES_MENU_TITLE, "VOIC"},
        {STRING_FOR_HARMONIZER_CHORD_MENU_TITLE, "CHRD"},
        {STRING_FOR_HARMONIZER_SNAP, "SNAP"},
        {STRING_FOR_HARMONIZER_SNAP_MENU_TITLE, "SNAP"},
        {STRING_FOR_HARMONIZER_TARGET, "TRGT"},
        {STRING_FOR_HARMONIZER_TARGET_MENU_TITLE, "TRGT"},
        {STRING_FOR_HARMONIZER_TARGET_CHORD_TONES, "CHTN"},
        {STRING_FOR_HARMONIZER_INTERVAL_VELOCITY, "IVEL"},
        {STRING_FOR_HARMONIZER_INTERVAL_VELOCITY_MENU_TITLE, "IVEL"},
        {STRING_FOR_HARMONIZER_PROBABILITY, "PROB"},
        {STRING_FOR_HARMONIZER_PROBABILITY_MENU_TITLE, "PROB"},
        {STRING_FOR_HARMONIZER_LATCH, "LTCH"},
        {STRING_FOR_HARMONIZER_LATCH_MENU_TITLE, "LTCH"},
    },
    &built_in::english,
};
} // namespace deluge::l10n::built_in
