...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_METRONOME_FOLLOW, "METR"},
        ...
        {STRING_FOR_TIME_SIGNATURE, "TSIG"},
        {STRING_FOR_TIME_SIG_NUMERATOR, "BEAT"},
        {STRING_FOR_TIME_SIG_DENOMINATOR, "UNIT"},
