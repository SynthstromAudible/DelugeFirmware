...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_CHORD_SIMULATOR, "CHRD"},
        {STRING_FOR_NOTE_MODE, "NMOD"},
        {STRING_FOR_NUMBER_OF_RATCHETS, "RATC"},
        {STRING_FOR_BASS_PROBABILITY, "BASS"},
        {STRING_FOR_CHORD_POLYPHONY, "POLY"},
        {STRING_FOR_CHORD_PROBABILITY, "CHRD"},
        {STRING_FOR_RATCHET_PROBABILITY, "RATC"},
        ...
        {STRING_FOR_DEFAULT_UI_KEYBOARD_LAYOUT_PIANO, "PIAN"},
        ...
        {STRING_FOR_CHORD_ROW_MODE, "ROW"},
        {STRING_FOR_CHORD_COLUMN_MODE, "COL"},
        {STRING_FOR_VELOCITY, "VEL"},
        {STRING_FOR_MODWHEEL, "MOD"},
        {STRING_FOR_CHORD, "CHRD"},
        {STRING_FOR_SONG_CHORD_MEMORY, "CMEM"},
        {STRING_FOR_CLIP_CHORD_MEMORY, "CCME"},
        {STRING_FOR_DX_OPERATORS, "DX"},
        {STRING_FOR_SONG_MACROS, "SONG"},
        {STRING_FOR_BEAT_REPEAT, "BEAT"},
    },
    &built_in::english,
};
} // namespace deluge::l10n::built_in
