...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_ROUND_ROBIN_VARIANTS, "VARI"},
        {STRING_FOR_VARIANTS, "VARI"},
        {STRING_FOR_VARIANT_SLOT_1, "SLT1"},
        {STRING_FOR_VARIANT_SLOT_2, "SLT2"},
        {STRING_FOR_VARIANT_SLOT_3, "SLT3"},
        {STRING_FOR_VARIANT_SLOT_4, "SLT4"},
        {STRING_FOR_MARKERS, "MARK"},
