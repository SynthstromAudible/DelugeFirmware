...
extern MenuItem* paramShortcutsForSoundsSecondPage[kDisplayWidth][kDisplayHeight];
...
extern deluge::gui::menu_item::Submenu* parentsForSoundShortcutsSecondPage[kDisplayWidth][kDisplayHeight];
