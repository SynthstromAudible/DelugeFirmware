...
submenu::Arpeggiator arpMenu{
    ...
    {
        &arpModeMenu, &arpSyncMenu, &arpOctavesMenu, &arpOctaveModeMenu, &arpNoteModeMenu, &arpGateMenu,
        &arpGateMenuMIDIOrCV, &arpRateMenu, &arpRateMenuMIDIOrCV, &arpSequenceLengthMenu,
