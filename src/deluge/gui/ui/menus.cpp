...
#include "gui/menu_item/harmonizer/chord_channel.h"
#include "gui/menu_item/harmonizer/interval.h"
#include "gui/menu_item/harmonizer/interval_velocity.h"
#include "gui/menu_item/harmonizer/latch.h"
#include "gui/menu_item/harmonizer/mode.h"
#include "gui/menu_item/harmonizer/probability.h"
#include "gui/menu_item/harmonizer/retrigger.h"
#include "gui/menu_item/harmonizer/tightness.h"
#include "gui/menu_item/harmonizer/transpose.h"
#include "gui/menu_item/harmonizer/voice_leading.h"
...
// Custom Submenu with isRelevant gating for runtime feature toggle
namespace {
class HarmonizerSubmenu final : public Submenu {
public:
...
// Harmonizer menu items
harmonizer::Mode harmModeMenu{STRING_FOR_HARMONIZER_SNAP, STRING_FOR_HARMONIZER_SNAP_MENU_TITLE};
harmonizer::Tightness harmTightnessMenu{STRING_FOR_HARMONIZER_TARGET, STRING_FOR_HARMONIZER_TARGET_MENU_TITLE};
harmonizer::VoiceLeading harmVoiceLeadMenu{STRING_FOR_HARMONIZER_VOICE_LEADING,
                                           STRING_FOR_HARMONIZER_VOICE_LEADING_MENU_TITLE};
harmonizer::Transpose harmTransposeMenu{STRING_FOR_TRANSPOSE, STRING_FOR_HARMONIZER_TRANSPOSE_MENU_TITLE};
harmonizer::Retrigger harmRetriggerMenu{STRING_FOR_HARMONIZER_RETRIGGER, STRING_FOR_HARMONIZER_RETRIGGER_MENU_TITLE};
harmonizer::ChordChannel harmChordChMenu{STRING_FOR_HARMONIZER_CHORD_CH, STRING_FOR_HARMONIZER_CHORD_CH_MENU_TITLE};
harmonizer::Interval harmIntervalMenu{STRING_FOR_HARMONIZER_INTERVAL, STRING_FOR_HARMONIZER_INTERVAL_MENU_TITLE};
harmonizer::IntervalVelocity harmIntervalVelocityMenu{STRING_FOR_HARMONIZER_INTERVAL_VELOCITY,
                                                      STRING_FOR_HARMONIZER_INTERVAL_VELOCITY_MENU_TITLE};
harmonizer::Probability harmProbabilityMenu{STRING_FOR_HARMONIZER_PROBABILITY,
                                            STRING_FOR_HARMONIZER_PROBABILITY_MENU_TITLE};
harmonizer::Latch harmLatchMenu{STRING_FOR_HARMONIZER_LATCH, STRING_FOR_HARMONIZER_LATCH_MENU_TITLE};

// Harmonizer: Page 1 - MAPPING (Snap, Target, VoiceLead, Transpose)
HorizontalMenu harmMappingMenu{STRING_FOR_HARMONIZER_SNAP,
                               STRING_FOR_HARMONIZER_MAPPING_MENU_TITLE,
                               {&harmModeMenu, &harmTightnessMenu, &harmVoiceLeadMenu, &harmTransposeMenu}};

// Harmonizer: Page 2 - VOICES (Interval, Int. Vel, Probability)
HorizontalMenu harmVoicesMenu{STRING_FOR_HARMONIZER_INTERVAL,
                              STRING_FOR_HARMONIZER_VOICES_MENU_TITLE,
                              {&harmIntervalMenu, &harmIntervalVelocityMenu, &harmProbabilityMenu}};

// Harmonizer: Page 3 - CHORD (Chord Ch, Latch, Retrigger)
HorizontalMenu harmChordMenu{STRING_FOR_HARMONIZER_CHORD_CH,
                             STRING_FOR_HARMONIZER_CHORD_MENU_TITLE,
                             {&harmChordChMenu, &harmLatchMenu, &harmRetriggerMenu}};

// Harmonizer: multi-page group (press button to cycle pages)
HorizontalMenuGroup harmMenuGroupMIDIOrCV{{&harmMappingMenu, &harmVoicesMenu, &harmChordMenu}};

// Harmonizer: top-level submenu (for MIDI/CV clips, gated by RuntimeFeature toggle)
HarmonizerSubmenu harmMenuMIDIOrCV{
    STRING_FOR_HARMONIZER,
    {
        &harmMappingMenu,
        &harmVoicesMenu,
        &harmChordMenu,
...
deluge::vector<HorizontalMenu*> horizontalMenusChainForMidiOrCv = {
	&arpMenuGroupMIDIOrCV, &harmMenuGroupMIDIOrCV, &randomizerMenu
};
