...
l10n::String functionNames[] = {
    /* VELOCITY       */ l10n::String::STRING_FOR_VELOCITY,
    /* MOD            */ l10n::String::STRING_FOR_MODWHEEL,
    /* CHORD          */ l10n::String::STRING_FOR_CHORD,
    /* SONG_CHORD_MEM */ l10n::String::STRING_FOR_SONG_CHORD_MEMORY,
    /* CHORD_MEM      */ l10n::String::STRING_FOR_CLIP_CHORD_MEMORY,
    /* SCALE_MODE     */ l10n::String::STRING_FOR_SCALE,
    /* DX             */ l10n::String::STRING_FOR_DX_OPERATORS,
    /* SESSION        */ l10n::String::STRING_FOR_SONG_MACROS,
    /* BEAT_REPEAT    */ l10n::String::STRING_FOR_BEAT_REPEAT,
};
...
bool ColumnControlsKeyboard::horizontalEncoderHandledByColumns(int32_t offset, bool shiftEnabled) {
	...
	if (leftColHeld == 7 && offset) {
		...
		display->displayPopup(l10n::getView(functionNames[state.leftColFunc]));
		state.leftCol = state.getColumnForFunc(state.leftColFunc);
		keyboardScreen.killColumnSwitchKey(LEFT_COL);
		return true;
	}
		...
		display->displayPopup(l10n::getView(functionNames[state.rightColFunc]));
		state.rightCol = state.getColumnForFunc(state.rightColFunc);
