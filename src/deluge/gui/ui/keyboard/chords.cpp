...
const Chord kMinor7b5 = {"-7\x81\x35",
...
const Chord kMinor9b5 = {
    "-9\x81\x35", NoteSet({ROOT, MIN3, DIM5, MIN7, MAJ2}), {{ROOT, MIN3, DIM5, MIN7, MAJ9, NONE, NONE}}};
const Chord kMinor7b5b9 = {
    "-7\x81\x35\x81\x39", NoteSet({ROOT, MIN3, DIM5, MIN7, MIN2}), {{ROOT, MIN3, DIM5, MIN7, MIN9, NONE, NONE}}};
const Chord k9 = {"9",
