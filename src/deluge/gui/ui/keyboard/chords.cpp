...
Chords::Chords()
    : chords{{"", {{0, 0, 0, 0, 0, 0}}},
             {"M", {{4, 7, 0, 0, 0, 0}, {16, 7, 0, 0, 0, 0}, {16, 7, -12, 0, 0, 0}}},
             {"-", {{3, 7, 0, 0, 0, 0}}},
             {"SUS2", {{2, 7, 0, 0, 0, 0}}},
             {"SUS4", {{5, 7, 0, 0, 0, 0}}},
             {"7", {{4, 7, 10, 0, 0, 0}}},
             ...
             {"-9", {{3, 7, 10, 14, 0, 0}}},
             {"11", {{4, 7, 10, 14, 17, 0}}},
             {"M11", {{4, 7, 11, 14, 17, 0}, {4 + 12, 7, 11, 14, 17, 0}}},
             {"-11", {{3, 7, 10, 14, 17, 0}, {3 + 12, 7, 10, 14, 17, 0}}},
             {"13", {{4, 7, 10, 14, 17, 21}, {4 + 12, 7, 10, 14, 17, 21}}},
             {"M13", {{4, 7, 11, 14, 17, 21}, {4 + 12, 7, 11, 14, 17, 21}}},
             {"-13", {{3, 7, 10, 14, 17, 21}, {3 + 12, 7, 10, 14, 17, 21}}}} {
}
