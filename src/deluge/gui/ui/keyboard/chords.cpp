...
// ChordList
PLACE_SDRAM_RODATA constexpr Chord kEmptyChord = {"", NoteSet({ROOT}), {{0, NONE, NONE, NONE, NONE, NONE}}};
PLACE_SDRAM_RODATA constexpr Chord kMajor = {"M",
...
PLACE_SDRAM_RODATA constexpr Chord kMinor = {"-",
...
PLACE_SDRAM_RODATA constexpr Chord kDim = {"DIM",
...
PLACE_SDRAM_RODATA constexpr Chord kFullDim = {
    "FULLDIM", NoteSet({ROOT, MIN3, DIM5, DIM7}), {{ROOT, MIN3, DIM5, DIM7, NONE, NONE, NONE}}};
PLACE_SDRAM_RODATA constexpr Chord kAug = {"AUG",
...
PLACE_SDRAM_RODATA constexpr Chord kSus2 = {"SUS2",
...
PLACE_SDRAM_RODATA constexpr Chord k7Sus4 = {"7SUS4",
...
PLACE_SDRAM_RODATA constexpr Chord k7Sus2 = {"7SUS2",
...
PLACE_SDRAM_RODATA constexpr Chord kM7 = {"M7",
...
PLACE_SDRAM_RODATA constexpr Chord kMinor7 = {"-7",
...
PLACE_SDRAM_RODATA constexpr Chord kMinor2 = {"-2",
...
PLACE_SDRAM_RODATA constexpr Chord kMinor4 = {"-4",
...
PLACE_SDRAM_RODATA constexpr Chord kMinorMaj7 = {"-M7",
...
PLACE_SDRAM_RODATA constexpr Chord kMinor7b5 = {"-7" FLAT_CHAR_STR "5",
...
PLACE_SDRAM_RODATA constexpr Chord kMinor9b5 = {
    "-9" FLAT_CHAR_STR "5", NoteSet({ROOT, MIN3, DIM5, MIN7, MAJ2}), {{ROOT, MIN3, DIM5, MIN7, MAJ9, NONE, NONE}}};
PLACE_SDRAM_RODATA constexpr Chord kMinor7b5b9 = {"-7" FLAT_CHAR_STR "5" FLAT_CHAR_STR "9",
                                                  NoteSet({ROOT, MIN3, DIM5, MIN7, MIN2}),
                                                  {{ROOT, MIN3, DIM5, MIN7, MIN9, NONE, NONE}}};
PLACE_SDRAM_RODATA constexpr Chord k9 = {"9",
...
PLACE_SDRAM_RODATA constexpr Chord kM9 = {"M9",
...
PLACE_SDRAM_RODATA constexpr Chord kMinor9 = {"-9",
...
PLACE_SDRAM_RODATA constexpr Chord k11 = {"11",
...
PLACE_SDRAM_RODATA constexpr Chord kM11 = {"M11",
...
PLACE_SDRAM_RODATA constexpr Chord kMinor11 = {"-11",
...
PLACE_SDRAM_RODATA constexpr Chord k13 = {"13",
...
PLACE_SDRAM_RODATA constexpr Chord kM13 = {"M13",
...
PLACE_SDRAM_RODATA constexpr Chord kM13Sharp11 = {"M13#11",
...
PLACE_SDRAM_RODATA constexpr Chord kMinor13 = {"-13",
