...
public:
	...
	virtual bool renderMainPads(uint32_t whichRows = 0, Colour image[][kDisplayWidth + kSideBarWidth] = NULL,
	                            uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth] = NULL,
	                            bool drawUndefinedArea = true) {
		return false;
	}
	virtual bool renderSidebar(uint32_t whichRows = 0, Colour image[][kDisplayWidth + kSideBarWidth] = NULL,
	                           uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth] = NULL) {
		return false;
	}
