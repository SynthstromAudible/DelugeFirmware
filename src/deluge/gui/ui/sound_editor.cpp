...
#include "gui/menu_item/menu_item_submenu.h"
#include "gui/menu_item/menu_item_patched_param.h"
#include "gui/menu_item/menu_item_unpatched_param.h"
#include "gui/menu_item/menu_item_selection.h"
#include "gui/menu_item/menu_item_decimal.h"
#include "gui/menu_item/menu_item_sync_level.h"
#include "gui/menu_item/menu_item_source_selection.h"
#include "gui/menu_item/menu_item_patch_cable_strength.h"
#include "gui/menu_item/menu_item_midi_command.h"
...
#include "gui/menu_item/menu_item_midi_devices.h"
#include "gui/menu_item/menu_item_runtime_feature_setting.h"
#include "gui/menu_item/menu_item_runtime_feature_settings.h"
...
public:
	...
	bool isRelevant(Sound* sound, int whichThing) {
		return (sound->modFXType == MOD_FX_TYPE_CHORUS || sound->modFXType == MOD_FX_TYPE_CHORUS_STEREO || sound->modFXType == MOD_FX_TYPE_PHASER);
	}
} modFXDepthMenu;
...
public:
	...
	bool isRelevant(Sound* sound, int whichThing) {
		return (!sound
		        || sound->modFXType == MOD_FX_TYPE_CHORUS  || sound->modFXType == MOD_FX_TYPE_CHORUS_STEREO); // TODO: really want to receive a ModControllableAudio here!
	}
} modFXOffsetMenu;
