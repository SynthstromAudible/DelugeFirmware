...
public:
	...
	static_vector<std::string_view, capacity()> getOptions() override { return {l10n::getView(l10n::String::STRING_FOR_LOW), l10n::getView(l10n::String::STRING_FOR_MEDIUM), l10n::getView(l10n::String::STRING_FOR_HIGH)}; }
};
} // namespace deluge::gui::menu_item::voice
