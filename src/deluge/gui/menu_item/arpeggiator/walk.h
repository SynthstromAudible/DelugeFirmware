...
class Walk final : public Selection {
public:
	using Selection::Selection;
	void readCurrentValue() override { this->setValue(soundEditor.currentArpSettings->walk); }
	void writeCurrentValue() override {
		auto current_value = this->getValue();

		soundEditor.currentArpSettings->walk = this->getValue() != 0;
	}
