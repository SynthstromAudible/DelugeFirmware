...
class HorizontalMenu final : public menu_item::HorizontalMenu {
	using menu_item::HorizontalMenu::HorizontalMenu;

	[[nodiscard]] std::string_view getTitle() const override {
		// Sorry, a bit of hacky casts here
		if (const_cast<HorizontalMenu*>(this)->renderingStyle()
		    == menu_item::HorizontalMenu::RenderingStyle::VERTICAL) {
