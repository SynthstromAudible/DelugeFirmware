...
public:
	...
	void readCurrentValue() override {
		this->set_value((((int64_t)AudioEngine::reverbCompressorShape + 2147483648) * 50 + 2147483648) >> 32);
	}
	void writeCurrentValue() override {
		AudioEngine::reverbCompressorShape = (uint32_t)this->get_value() * 85899345 - 2147483648;
