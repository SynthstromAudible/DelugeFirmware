...
class FollowChannelParam final : public Integer {
public:
	...
	void drawInteger(int32_t textWidth, int32_t textHeight, int32_t yPixel) {
		...
		if (midiEngine.midiFollowChannelType[util::to_underlying(MIDIFollowChannelType::PARAM)].device) {
			deviceString = midiEngine.midiFollowChannelType[util::to_underlying(MIDIFollowChannelType::PARAM)]
		...
		if (midiEngine.midiFollowChannelType[util::to_underlying(MIDIFollowChannelType::PARAM)].channelOrZone
			...
			int32_t channelmod =
			    ...
			    * IS_A_CC;
			intToString(
			    midiEngine.midiFollowChannelType[util::to_underlying(MIDIFollowChannelType::PARAM)].channelOrZone + 1
			        - channelmod,
			    buffer, 1);
