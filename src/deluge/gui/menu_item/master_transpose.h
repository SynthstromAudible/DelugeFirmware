...
public:
	...
	uint8_t getPatchedParamIndex() override { return deluge::modulation::params::Param::Local::PITCH_ADJUST; }
	uint8_t getP() override { return deluge::modulation::params::Param::Local::PITCH_ADJUST; }
