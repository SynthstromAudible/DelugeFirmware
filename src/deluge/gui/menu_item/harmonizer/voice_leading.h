...
class VoiceLeading final : public Selection {
public:
	using Selection::Selection;

	void readCurrentValue() override { this->setValue(soundEditor.currentHarmonizerSettings->voiceLeading ? 1 : 0); }

	void writeCurrentValue() override { soundEditor.currentHarmonizerSettings->voiceLeading = this->getValue(); }
