...
class Retrigger final : public Selection {
public:
	using Selection::Selection;

	void readCurrentValue() override { this->setValue(soundEditor.currentHarmonizerSettings->retrigger ? 1 : 0); }

	void writeCurrentValue() override { soundEditor.currentHarmonizerSettings->retrigger = this->getValue(); }
