...
public:
	...
	void readCurrentValue() { this->set_value(soundEditor.currentSound->unisonStereoSpread); }
	void writeCurrentValue() { soundEditor.currentSound->setUnisonStereoSpread(this->get_value()); }
