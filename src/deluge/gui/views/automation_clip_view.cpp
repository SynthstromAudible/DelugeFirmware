...
const uint32_t paramsForAutomation[41] = {
		PARAM_GLOBAL_VOLUME_POST_FX, PARAM_LOCAL_PITCH_ADJUST, PARAM_LOCAL_PAN, //Master Volume, Pan, Pitch
		PARAM_LOCAL_LPF_FREQ, PARAM_LOCAL_LPF_RESONANCE, //LPF Cutoff, Resonance
		PARAM_LOCAL_HPF_FREQ, PARAM_LOCAL_HPF_RESONANCE, //HPF Cutoff, Resonance
		PARAM_GLOBAL_REVERB_AMOUNT, //Reverb Amount
		PARAM_GLOBAL_DELAY_RATE, PARAM_GLOBAL_DELAY_FEEDBACK, //Delay Rate, Feedback
		PARAM_GLOBAL_VOLUME_POST_REVERB_SEND, //Sidechain Send
		PARAM_LOCAL_OSC_A_VOLUME, PARAM_LOCAL_OSC_A_PITCH_ADJUST, PARAM_LOCAL_OSC_A_PHASE_WIDTH,
			PARAM_LOCAL_CARRIER_0_FEEDBACK, PARAM_LOCAL_OSC_A_WAVE_INDEX, //OSC 1 Volume, Pitch, Phase Width, Carrier Feedback, Wave Index
		PARAM_LOCAL_OSC_B_VOLUME, PARAM_LOCAL_OSC_B_PITCH_ADJUST, PARAM_LOCAL_OSC_B_PHASE_WIDTH,
			PARAM_LOCAL_CARRIER_1_FEEDBACK, PARAM_LOCAL_OSC_B_WAVE_INDEX, //OSC 2 Volume, Pitch, Phase Width, Carrier Feedback, Wave Index
		PARAM_LOCAL_MODULATOR_0_VOLUME, PARAM_LOCAL_MODULATOR_0_PITCH_ADJUST, PARAM_LOCAL_MODULATOR_0_FEEDBACK, //FM Mod 1 Volume, Pitch, Feedback
		PARAM_LOCAL_MODULATOR_1_VOLUME, PARAM_LOCAL_MODULATOR_1_PITCH_ADJUST, PARAM_LOCAL_MODULATOR_1_FEEDBACK, //FM Mod 2 Volume, Pitch, Feedback
		PARAM_LOCAL_ENV_0_ATTACK, PARAM_LOCAL_ENV_0_DECAY, PARAM_LOCAL_ENV_0_SUSTAIN, PARAM_LOCAL_ENV_0_RELEASE, //Env 1 ADSR
		PARAM_LOCAL_ENV_1_ATTACK, PARAM_LOCAL_ENV_1_DECAY, PARAM_LOCAL_ENV_1_SUSTAIN, PARAM_LOCAL_ENV_1_RELEASE, //Env 2 ADSR
		PARAM_GLOBAL_LFO_FREQ, PARAM_LOCAL_LFO_LOCAL_FREQ, //LFO 1 Freq, LFO 2 Freq
		PARAM_GLOBAL_MOD_FX_DEPTH, PARAM_GLOBAL_MOD_FX_RATE, //Mod FX Depth, Rate
		PARAM_GLOBAL_ARP_RATE, //Arp Rate
		PARAM_LOCAL_NOISE_VOLUME //Noise
};
...
const uint32_t paramShortcutsForAutomation[16][8] = {
	    ...
	    {PARAM_LOCAL_OSC_A_VOLUME, PARAM_LOCAL_OSC_A_PITCH_ADJUST, 0xFFFFFFFF, PARAM_LOCAL_OSC_A_PHASE_WIDTH, 0xFFFFFFFF, PARAM_LOCAL_CARRIER_0_FEEDBACK,
	    		PARAM_LOCAL_OSC_A_WAVE_INDEX, PARAM_LOCAL_NOISE_VOLUME},
	    {PARAM_LOCAL_OSC_B_VOLUME, PARAM_LOCAL_OSC_B_PITCH_ADJUST, 0xFFFFFFFF, PARAM_LOCAL_OSC_B_PHASE_WIDTH, 0xFFFFFFFF, PARAM_LOCAL_CARRIER_1_FEEDBACK,
	    		PARAM_LOCAL_OSC_B_WAVE_INDEX, 0xFFFFFFFF},
	    {PARAM_LOCAL_MODULATOR_0_VOLUME, PARAM_LOCAL_MODULATOR_0_PITCH_ADJUST, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
	    		PARAM_LOCAL_MODULATOR_0_FEEDBACK, 0xFFFFFFFF, 0xFFFFFFFF},
	    {PARAM_LOCAL_MODULATOR_1_VOLUME, PARAM_LOCAL_MODULATOR_1_PITCH_ADJUST, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
	    		PARAM_LOCAL_MODULATOR_1_FEEDBACK, 0xFFFFFFFF, 0xFFFFFFFF},
	    {PARAM_GLOBAL_VOLUME_POST_FX, 0xFFFFFFFF, PARAM_LOCAL_PITCH_ADJUST, PARAM_LOCAL_PAN, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF},
	    {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF},
	    {PARAM_LOCAL_ENV_0_RELEASE, PARAM_LOCAL_ENV_0_SUSTAIN, PARAM_LOCAL_ENV_0_DECAY, PARAM_LOCAL_ENV_0_ATTACK, 0xFFFFFFFF, 0xFFFFFFFF, PARAM_LOCAL_LPF_RESONANCE, PARAM_LOCAL_LPF_FREQ},
	    {PARAM_LOCAL_ENV_1_RELEASE, PARAM_LOCAL_ENV_1_SUSTAIN, PARAM_LOCAL_ENV_1_DECAY, PARAM_LOCAL_ENV_1_ATTACK, 0xFFFFFFFF, 0xFFFFFFFF, PARAM_LOCAL_HPF_RESONANCE, PARAM_LOCAL_HPF_FREQ},
	    {0xFFFFFFFF, 0xFFFFFFFF, PARAM_GLOBAL_VOLUME_POST_REVERB_SEND, 0xFFFFFFFF,
	    		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF},
	    {PARAM_GLOBAL_ARP_RATE, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
	    		0xFFFFFFFF},
	    {PARAM_GLOBAL_LFO_FREQ, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, PARAM_GLOBAL_MOD_FX_DEPTH,
	    		PARAM_GLOBAL_MOD_FX_RATE},
	    {PARAM_LOCAL_LFO_LOCAL_FREQ, 0xFFFFFFFF, 0xFFFFFFFF, PARAM_GLOBAL_REVERB_AMOUNT, 0xFFFFFFFF, 0xFFFFFFFF,
	    		0xFFFFFFFF, 0xFFFFFFFF},
	    {PARAM_GLOBAL_DELAY_RATE, 0xFFFFFFFF, 0xFFFFFFFF, PARAM_GLOBAL_DELAY_FEEDBACK, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF},
		{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF}
};
...
void AutomationClipView::openedInBackground() {
	char const* displayText;
	displayText = "openedInBackground";
	numericDriver.displayPopup(displayText);
...
int AutomationClipView::buttonAction(hid::Button b, bool on, bool inCardRoutine) {
...
//			//changeRootUI(&keyboardScreen); //temporarily disable keyboardScreen to get automationScreen working
...
//	}
	...
	// Save / delete button if NoteRow held down
			...
			for (i = 0; i < editPadPressBufferSize; i++) {
				if (editPadPresses[i].isActive) {
					...
					if (yDisplay < (displayHeight >> 1)) {
						if (!noteRowIndex || clip->noteRows.getNumElements() >= (displayHeight >> 1)) {
							clip->yScroll--;
						}
					}
		...
		else if (clip->output->type == INSTRUMENT_TYPE_MIDI_OUT) {
			//ModelStackWithThreeMainThings* modelStackWithThreeMainThings = modelStack->addOtherTwoThingsButNoNoteRow(clip->output->toModControllable(), &clip->paramManager);
			//if (modelStackWithThreeMainThings) {
			//	ParamCollectionSummary* summary = modelStackWithThreeMainThings->paramManager->getPatchedParamSetSummary();
			//	if (summary) {
...
void AutomationClipView::createDrumForAuditionedNoteRow(int drumType) {
	char const* displayText;
	displayText = "createDrumForAudNoteRow";
	numericDriver.displayPopup(displayText);
...
/*	else {
		if (whichModEncoder == 0 && on){
			...
			if (currentSong->currentClip->output->type == INSTRUMENT_TYPE_SYNTH || currentSong->currentClip->output->type == INSTRUMENT_TYPE_KIT) {
			...
			else if (currentSong->currentClip->output->type == INSTRUMENT_TYPE_MIDI_OUT) {
...
void AutomationClipView::copyNotes() {
...
void AutomationClipView::deleteCopiedNoteRows() {
...
void AutomationClipView::pasteNotes() {
...
void AutomationClipView::createNewInstrument(uint8_t newInstrumentType) {
...
void AutomationClipView::changeInstrumentType(uint8_t newInstrumentType) { //change instrument type inside of current clip in focus
...
int AutomationClipView::padAction(int x, int y, int velocity) {
	...
	//	numericDriver.displayPopup(displayText);
		...
		if (velocity) { //&& (!isUIModeActive(UI_MODE_AUDITIONING) || !editedAnyPerNoteRowStuffSinceAuditioningBegan)) {
			...
			//	if (currentSong->currentClip->output->type == INSTRUMENT_TYPE_SYNTH || currentSong->currentClip->output->type == INSTRUMENT_TYPE_KIT) {
				...
				//	if (x == 0 && y == 6) { //interpolate values

			/*			if (interpolateOn == 0) {
							interpolateOn = 1;

							char* displayText;
							displayText = "Interp On";
							numericDriver.displayPopup(displayText);
								...
								if (summary) {
									...
									if (modelStackWithParam) {
										...
										for (int xDisplay = 0; xDisplay < displayWidth; xDisplay++) {
											uint32_t squareStart = getPosFromSquare(xDisplay);
											int effectiveLength = currentSong->currentClip->loopLength;
											if (squareStart < effectiveLength) {
											...
											//	int knobPos = modelStackWithParam->paramCollection->paramValueToKnobPos(previousValue, modelStackWithParam);
												...
												int A = 0;
												int B = 127;
												int Ax = 0;//((effectiveLength+1)/2)-1;
												int Bx = 7;//((effectiveLength)/2);
												int Distance = Bx - Ax;

											//	char buffer[5];
												//char* displayText;

											//	intToString(effectiveLength, buffer);
											//	numericDriver.displayPopup(buffer);

											//	if (xDisplay < effectiveLength/2) {
											//		newKnobPos = LERPSweep(A, B,xDisplay,Distance);

											//	newKnobPos = LERP (A,B,xDisplay,Distance);


												//Sweep up to 127

								//				if (squareStart < effectiveLength/2) {
								//					newKnobPos = LERPSweep (A, B, xDisplay, ((Distance+1)/2)-1);
								//				}

												//Peak at 127

								//				else if (squareStart == effectiveLength/2) {
								//					newKnobPos = LERPSweep (A, B, xDisplay - 1, ((Distance+1)/2)-1);
								//				}

												//Sweep down to 0

								//				else {
								//					newKnobPos = LERPSweep (A, B, Distance - xDisplay, ((Distance+1)/2)-1);
								//				}

												//Straight up to 127

									//			if (squareStart < effectiveLength/2) {
									//				newKnobPos = LERP (A, B, xDisplay, ((Distance+1)/2)-1);
									//			}

												//Peak at 127

									//			else if (squareStart == effectiveLength/2) {
									//				newKnobPos = LERP (A, B, xDisplay - 1, ((Distance+1)/2)-1);
									//			}

												//Straight down to 0

									//			else {
									//				newKnobPos = LERP (A, B, Distance - xDisplay, ((Distance+1)/2)-1);
									//			}

												//Root curve up to 127

									//			if (squareStart < effectiveLength/2) {
									//				newKnobPos = LERPRoot (A, B, Bx - xDisplay, Bx);
									//			}

												//Peak at 127

									//			else if (squareStart == effectiveLength/2) {
									//				newKnobPos = LERPRoot (A, B, Bx - xDisplay + 1, Bx);
									//			}

												//Root curve down to 0

									//			else {
									//				newKnobPos = LERPRoot (A, B, xDisplay - Distance - 1, Bx);
									//			}

												//Smoothstep

												//bell curve up to 127
										//		if (squareStart < effectiveLength/2) {
										//			A = LERPSweep (A, B, xDisplay, Distance);
										//			B = LERPRoot (A, B, Bx - xDisplay, Distance);
										//			newKnobPos = LERP (A, B, xDisplay, Distance);
										//		}

												//Peak at 127
										//		else if (squareStart == effectiveLength/2) {
										//			A = LERPSweep (A, B, xDisplay - 1, Distance);
										//			B = LERPRoot (A, B, xDisplay - Distance - 1, Distance);
										//			newKnobPos = LERP (A, B, xDisplay - 1, Distance);
										//		}

												//bell curve down to 0

										//		else {
										//			A = LERPSweep (A, B, Distance + (Distance - xDisplay) + 1, Distance);
										//			B = LERPRoot (A, B, xDisplay - Distance - 1, Distance);
										//			newKnobPos = LERP (A, B, Distance + (Distance - xDisplay) + 1, Distance);
										//		}
											...
											//	else {
											//		newKnobPos = LERPSweep(127, 0,EffectiveLength-xDisplay-2,Distance);
											//	}

												//char buffer[5];
												//char* displayText;

											//	intToString(newKnobPos, buffer);
											//	numericDriver.displayPopup(buffer);
...
//	numericDriver.displayPopup(displayText);
	...
	//	char const* displayText;
	//	displayText = "editPadAction 3";
	//	numericDriver.displayPopup(displayText);

	//	bool editPadPressFound = false;

	//	for (int y = 0; y < displayHeight; y++) {
	//		if (numEditPadPressesPerNoteRowOnScreen[y] == 1) {
	//			bool editPadPressFound = true;
	...
	//	}
		...
		if (numEditPadPresses == 1 && //(editPadPressFound == true && //(numEditPadPressesPerNoteRowOnScreen[yDisplay] == 1 &&
		...
		//	char const* displayText;
		//	displayText = "note length press";
		//	numericDriver.displayPopup(displayText);

			//getEditPadPressXDisplayOnScreen(yDisplay)
			...
			for (i = 0; i < editPadPressBufferSize; i++) {
				...
				//	int valueForDisplay = editPadPresses[i].yDisplay;
			...
			/*	char modelStackMemory[MODEL_STACK_MAX_SIZE];
				...
				if (modelStack) {
					...
					int secondPadX = xDisplay;
					int secondPadY = yDisplay;
					int firstPadValue = 0;
					int secondPadValue = 0;


					if (firstPadY >= 0 && firstPadY < 7) {
						firstPadValue = firstPadY * 18;
					}
					else {
						firstPadValue = 127;
					}

					if (secondPadY >= 0 && secondPadY < 7) {
						secondPadValue = secondPadY * 18;
					}
					else {
						secondPadValue = 127;
					}
							...
							for (int x = firstPadX; x <= secondPadX; x++) {
								...
								//	int32_t newKnobPos = 0;
									...
									setParameterAutomationValue(modelStackWithParam, newKnobPos, squareStart, x, effectiveLength);
										...
										//		else {
													//f(x) = A + (x - Ax) * ((B - A) / (Bx - Ax))
										//			newKnobPos = A + (x - Ax)*((((B - A) * 1000000) / (Bx - Ax)) / 1000000);
										//		}

											//	if (x <= Bx) {
											//		newKnobPos = LERP (A, B, x, Distance);
											//	}
								...
								//				}
									...
									//			}
												...
												//bell curve up to 127
									//			if (squareStart < effectiveLength/2) {
									//				A = LERPSweep (A, B, x, Distance);
									//				B = LERPRoot (A, B, Bx - x, Distance);
									//				newKnobPos = LERP (A, B, x, Distance);
									//			}

												//Peak at 127
									//			else if (squareStart == effectiveLength/2) {
									//				A = LERPSweep (A, B, x - 1, Distance);
									//				B = LERPRoot (A, B, x - Distance - 1, Distance);
									//				newKnobPos = LERP (A, B, x - 1, Distance);
									//			}

												//bell curve down to 0

									//			else {
									//				A = LERPSweep (A, B, Distance + (Distance - x) + 1, Distance);
									//				B = LERPRoot (A, B, x - Distance - 1, Distance);
									//				newKnobPos = LERP (A, B, Distance + (Distance - x) + 1, Distance);
									//			}
											...
											//	modelStackWithParam->autoParam->setValueForRegion(squareStart, squareWidth, newValue, modelStackWithParam);
											//	modelStackWithParam->autoParam->setValueForRegion(squareStart, squareWidth, newValue, modelStackWithParam);
											...
											//	view.notifyParamAutomationOccurred(modelStackWithParam->paramManager);
											//	modelStackWithParam->paramManager->notifyParamModifiedInSomeWay(modelStackWithParam, true, false, true);
		...
		// Or, if this is a regular create-or-select press...
			...
			if (i < editPadPressBufferSize) {
				...
				/*	if (clip->output->type == INSTRUMENT_TYPE_SYNTH) { //|| clip->output->type == INSTRUMENT_TYPE_MIDI_OUT){
						...
						//		if (summary) {
						//			ParamSet* paramSet = (ParamSet*)summary->paramCollection;
									//int paramId = PARAM_LOCAL_LPF_FREQ;
						//			ModelStackWithAutoParam* modelStackWithParam = modelStackWithThreeMainThings->addParam(paramSet, summary, lastSelectedParamID, &paramSet->params[lastSelectedParamID]);
							...
							if (modelStackWithParam) {
										...
										//		if (view.modLength && modelStack->getTimelineCounter() == view.activeModControllableModelStack.getTimelineCounterAllowNull()) {
										//			modPos = view.modPos;
										//		}
										//	}
								...
								if (squareStart < effectiveLength) {
									...
									setParameterAutomationValue(modelStackWithParam, newKnobPos, squareStart, xDisplay, effectiveLength);
											...
											//	int valueForDisplay = knobPos;//newKnobPos;
												...
												//	bool isPlaying = (playbackHandler.isEitherClockActive() && !playbackHandler.ticksLeftInCountIn
											...
											//		int valueForDisplay = newKnobPos;//newKnobPos;

												//	int renderWidth = displayWidth;
												//	int imageWidth = displayWidth + sideBarWidth;
												//	uint8_t image[][displayWidth + sideBarWidth][3] = &PadLEDs::imageStore[displayHeight];

												//	if (pixelOn == false) {

													//	image += yDisplay * (imageWidth * 3);
												...
												//	lastAuditionedAutomationPadY = yDisplay;
												//	lastAuditionedAutomationPadX = xDisplay;
											//	}
											//	else {
											//		columnSelected = xDisplay;
											//	}

											//	char buffer[5];
											//	char* displayText;

											//	int valueForDisplay = xDisplay;
											//	intToString(valueForDisplay, buffer);

											//	if (lastSelectedParamID == PARAM_LOCAL_LPF_FREQ) {
											//		displayText = "LPFC:";
											//	}
											//	else if (lastSelectedParamID == PARAM_LOCAL_LPF_RESONANCE) {
											//		displayText = "LPFR:";
											//	}
											//	else if (lastSelectedParamID == PARAM_LOCAL_OSC_A_PITCH_ADJUST) {
											//		displayText = "LPFR:";
											//	}
											//	numericDriver.displayPopup(buffer);
											...
											//			modelStackWithParam->autoParam->setCurrentValueInResponseToUserInput(newValue, modelStackWithParam, true, getPosFromSquare(xDisplay), false, false);

											//		}
											//		else {
											//			modelStackWithParam->autoParam->setCurrentValueWithNoReversionOrRecording(modelStackWithParam, newValue);
											//		}
											...
											//	}
												...
												//modelStackWithParam->autoParam->setValuePossiblyForRegion(newValue, modelStackWithParam, getPosFromSquare(xDisplay), squareWidth);
...
Sound* AutomationClipView::getSoundForNoteRow(NoteRow* noteRow, ParamManagerForTimeline** getParamManager) {
	if (currentSong->currentClip->output->type == INSTRUMENT_TYPE_SYNTH) {
...
void AutomationClipView::adjustVelocity(int velocityChange) {
...
void AutomationClipView::adjustProbability(int offset) {
...
fail:
	...
	if (!wasStuttering && clip->output->type == INSTRUMENT_TYPE_KIT) {
		setSelectedDrum(noteRow->drum);
	}
...
void AutomationClipView::recalculateColours() {
	...
	char const* displayText;
	displayText = "recalculateColours";
	numericDriver.displayPopup(displayText);
...
int AutomationClipView::scrollVertical(int scrollAmount, bool inCardRoutine, bool draggingNoteRow) {
...
//	numericDriver.displayPopup(displayText);
	...
	if (modelStack) {
		ModelStackWithNoteRow* modelStackWithNoteRow = ((InstrumentClip*)modelStack->getTimelineCounter())->getNoteRowOnScreen(yDisplay, modelStack);
		NoteRow* noteRow = modelStackWithNoteRow->getNoteRowAllowNull();
			...
			if (clip->output->type == INSTRUMENT_TYPE_SYNTH) {
				...
				if (modelStackWithThreeMainThings) {
					...
					if (summary) {
						ParamSet* paramSet = (ParamSet*)summary->paramCollection;
						int paramId = PARAM_LOCAL_LPF_FREQ;
						ModelStackWithAutoParam* modelStackWithParam = modelStackWithThreeMainThings->addParam(paramSet, summary, paramId, &paramSet->params[paramId]);
...
Drum* AutomationClipView::flipThroughAvailableDrums(int newOffset, Drum* drum, bool mayBeNone) {
...
Drum* AutomationClipView::getNextDrum(Drum* oldDrum, bool mayBeNone) {
	if (oldDrum == NULL) {
...
void AutomationClipView::enterDrumCreator(ModelStackWithNoteRow* modelStack, bool doRecording) {
...
void AutomationClipView::deleteDrum(SoundDrum* drum) {
...
void AutomationClipView::drawNoteCode(uint8_t yDisplay) {
...
void AutomationClipView::drawDrumName(Drum* drum, bool justPopUp) {
...
int AutomationClipView::setupForEnteringScaleMode(int newRootNote, int yDisplay) {
...
void AutomationClipView::enterScaleMode(uint8_t yDisplay) {
	...
	for (int i = 0; i < clip->noteRows.getNumElements(); i++) {
		...
		if ((yDisplayTo >= 0 && yDisplayTo < displayHeight) || (yDisplayFrom >= 0 && yDisplayFrom < displayHeight)) {
			...
			if (PadLEDs::numAnimatedRows >= MAX_NUM_ANIMATED_ROWS) {
				break;
			}
		}
	}
...
int AutomationClipView::setupForExitingScaleMode() {
...
void AutomationClipView::setupChangingOfRootNote(int newRootNote, int yDisplay) {
...
bool AutomationClipView::renderSidebar(uint32_t whichRows, uint8_t image[][displayWidth + sideBarWidth][3],
...
void AutomationClipView::drawMuteSquare(NoteRow* thisNoteRow, uint8_t thisImage[][3], uint8_t thisOccupancyMask[]) {
...
int AutomationClipView::verticalEncoderAction(int offset, bool inCardRoutine) {
...
int AutomationClipView::horizontalEncoderAction(int offset) {
...
void AutomationClipView::quantizeNotes(int offset, int nudgeMode) {
...
void AutomationClipView::editNoteRepeat(int offset) {
	...
	for (int yDisplay = 0; yDisplay < displayHeight; yDisplay++) {
		...
		if (!reallyNoTickSquare) {
			if (noteRow && noteRow->hasIndependentPlayPos()) {
				...
				if (rowTickSquare < 0 || rowTickSquare >= displayWidth) {
					rowTickSquare = 255;
				}
...
void AutomationClipView::fillOffScreenImageStores() {
...
bool AutomationClipView::renderMainPads(uint32_t whichRows, uint8_t image[][displayWidth + sideBarWidth][3],
	...
	if (lastSelectedParamID != 255 && (clip->output->type == INSTRUMENT_TYPE_SYNTH || clip->output->type == INSTRUMENT_TYPE_KIT)) {
		soundEditor.setupShortcutBlink(lastSelectedParamX, lastSelectedParamY, 3);
		soundEditor.blinkShortcut();
	}

	else if (lastSelectedMidiCC != 255 && clip->output->type == INSTRUMENT_TYPE_MIDI_OUT) {
		soundEditor.setupShortcutBlink(lastSelectedMidiX, lastSelectedMidiY, 3);
		soundEditor.blinkShortcut();
	}
...
void AutomationClipView::performActualRender(uint32_t whichRows, uint8_t* image,
	...
	//	}
		...
		if (clip->output->type == INSTRUMENT_TYPE_SYNTH && lastSelectedParamID != 255) {
		...
		//			ModelStackWithAutoParam* modelStackWithParam = modelStackWithThreeMainThings->addParam(paramSet, summary, lastSelectedParamID, &paramSet->params[lastSelectedParamID]);
			...
			if (modelStackWithParam) {
				...
				for (int xDisplay = 0; xDisplay < displayWidth; xDisplay++) {
					...
					uint8_t* pixel = image + (yDisplay * imageWidth * 3) + (xDisplay * 3);
										...
										//	if (yDisplay == 0) {
										//		if (columnSelected == xDisplay) {
										//			menu_item::activeColourMenu.getRGB(pixel);
										//		}
										//		else {
										//			pixel[0] = 0;
										//			pixel[1] = 0;
					...
					if (knobPos == 0 || (knobPos < yDisplay * 18)) {
						...
						pixel[2] = 0;
												...
												//	goto RenderPad;
											//	int relativeKnobPos = (knobPos/18);//-yDisplay;
											//	char buffer[19];
											//	strcpy(buffer, "KnobPos: ");
											//	intToString(knobPos, buffer + strlen(buffer));
											//	OLED::popupText(buffer);

											//	if (0 <= relativeKnobPos <= 1) {
						...
						memcpy(pixel,&rowColour[yDisplay],3);
									//	}
										...
										//	RenderPad:
											...
											//						   renderWidth, false, true);

													//	uint8_t* pixel = image + (lastAuditionedAutomationPadY * imageWidth * 3) + (lastAuditionedAutomationPadX * 3); //+ xDisplay * 3;
		...
		else if (clip->output->type == INSTRUMENT_TYPE_MIDI_OUT && lastSelectedMidiCC != 255) {
			//ModelStackWithThreeMainThings* modelStackWithThreeMainThings = modelStack->addOtherTwoThingsButNoNoteRow(clip->output->toModControllable(), &clip->paramManager);
			//if (modelStackWithThreeMainThings) {
			//	ModelStackWithAutoParam* modelStackWithParam = getParamToControlFromInputMIDIChannel(lastSelectedMidiCC, modelStackWithThreeMainThings);
			...
			if (clip->output->type == INSTRUMENT_TYPE_SYNTH) {
				for (int xDisplay = 0; xDisplay < displayWidth; xDisplay++) {
					...
					//		if (summary) {
					//			ParamSet* paramSet = (ParamSet*)summary->paramCollection;
					//			ModelStackWithAutoParam* modelStackWithParam = modelStackWithThreeMainThings->addParam(paramSet, summary, paramShortcutsForAutomation[xDisplay][yDisplay], &paramSet->params[paramShortcutsForAutomation[xDisplay][yDisplay]]);
			...
			else if (clip->output->type == INSTRUMENT_TYPE_KIT) {
				...
				for (int xDisplay = 0; xDisplay < displayWidth; xDisplay++) {
					...
					//	ModelStackWithThreeMainThings* modelStackWithThreeMainThings = modelStack->addOtherTwoThingsButNoNoteRow(clip->output->toModControllable(), &clip->paramManager);
					//	if (modelStackWithThreeMainThings) {
					//		ModelStackWithAutoParam* modelStackWithParam = getParamToControlFromInputMIDIChannel(midiCCShortcutsForAutomation[xDisplay][yDisplay], modelStackWithThreeMainThings);
...
//*****NEEDED FOR AUTOMATION VIEW******//
	...
	//	renderRow(rowColour[yDisplay], rowTailColour[yDisplay], rowBlurColour[yDisplay], image,
	//					                   occupancyMaskOfRow, true, renderWidth, xScroll, xZoom, 0,
...
void AutomationClipView::renderRow(uint8_t rowColour[], uint8_t rowTailColour[],
        uint8_t rowBlurColour[], uint8_t* image, uint8_t occupancyMask[],
		bool overwriteExisting, int renderWidth, int32_t xScroll,
        uint32_t xZoom, int xStartNow, int xEnd, bool drawRepeats, int yStart) {
					...
					if (summary) {
						...
						if (modelStackWithParam) {
							...
							//	}
								...
								//for (int xDisplay = xStartNow; xDisplay < xEnd; xDisplay++) {
								//do {
...
//	char const* displayText;
//	displayText = "performActualRender";
//	numericDriver.displayPopup(displayText);
	...
	for (int yDisplay = 0; yDisplay < displayHeight; yDisplay++) {
		...
		if (whichRows & (1 << yDisplay)) {
			...
			//ModelStackWithNoteRow* modelStackWithNoteRow = clip->getNoteRowOnScreen(dummyY, modelStack); //this is where you specify what row you want to get note information from
			//ModelStackWithNoteRow* modelStackWithNoteRow = clip->getNoteRowOnScreen(yDisplay, modelStack);
			ModelStackWithNoteRow* modelStackWithNoteRow = ((InstrumentClip*)modelStack->getTimelineCounter())->getNoteRowOnScreen(yDisplay, modelStack);
			...
			if (!noteRow) {// || !unpatchedParamsSummary->containsAutomation() || !patchedParamsSummary->containsAutomation()) {
			//	memset(image, 0, renderWidth * 3);
			//	if (occupancyMask) {
			...
			//	ParamCollectionSummary* unpatchedParamsSummary = noteRow->paramManager.getUnpatchedParamSetSummary();
			//	ParamCollectionSummary* patchedParamsSummary = noteRow->paramManager.getPatchedParamSetSummary();
			...
			//	if (unpatchedParamsSummary->containsAutomation() || patchedParamsSummary->containsAutomation()) {

			//		noteRow->renderRow(this, rowColour[yDisplay], rowTailColour[yDisplay], rowBlurColour[yDisplay], image,
			//						occupancyMaskOfRow, true, modelStackWithNoteRow->getLoopLength(),
			//						clip->allowNoteTails(modelStackWithNoteRow), renderWidth, xScroll, xZoom, 0,
			//						renderWidth, false);
			//	noteRow->renderRow(this, rowColour[dummyY], rowTailColour[dummyY], rowBlurColour[dummyY], image,
			//	                   occupancyMaskOfRow, true, modelStackWithNoteRow->getLoopLength(),
			//	                   clip->allowNoteTails(modelStackWithNoteRow), renderWidth, xScroll, xZoom, 0,
			//	                   renderWidth, false);
			...
			//	ModelStackWithThreeMainThings* modelStack3 = soundEditor.getCurrentModelStack(modelStackMemory);
			//	ParamCollectionSummary* summary = modelStack3->paramManager->getPatchedParamSetSummary();
			...
			//	ParamCollectionSummary* summary = modelStackWithThreeMainThingsForNoteRow->
	...
	//				else {
				//		param = &mpeParams->params[PARAM_LOCAL_LPF_FREQ];
					...
					if (modelStackWithThreeMainThings) {
						...
						if (summary) {
							...
							//	}
								...
								//	renderRow(this, rowColour[yDisplay], rowTailColour[yDisplay], rowBlurColour[yDisplay], image,
								//		                   occupancyMaskOfRow, true, modelStackWithNoteRow->getLoopLength(),
								//		                   clip->allowNoteTails(modelStackWithNoteRow), renderWidth, xScroll, xZoom, 0,
								//		                   renderWidth, false);
				...
				else if (clip->output->type == INSTRUMENT_TYPE_CV) {
				}
			}
...
void AutomationClipView::renderRow(TimelineView* editorScreen, uint8_t rowColour[], uint8_t rowTailColour[],
...
void AutomationClipView::clipNeedsReRendering(Clip* clip) {
	if (clip == getCurrentClip()) {
...
void AutomationClipView::modEncoderAction(int whichModEncoder, int offset) {
	...
	if (output->type == INSTRUMENT_TYPE_KIT && isUIModeActive(UI_MODE_AUDITIONING)) {
		...
		if (clip->output->type == INSTRUMENT_TYPE_SYNTH || clip->output->type == INSTRUMENT_TYPE_KIT) {
...
void AutomationClipView::editNumEuclideanEvents(ModelStackWithNoteRow* modelStack, int offset, int yDisplay) {
...
void AutomationClipView::editNoteRowLength(ModelStackWithNoteRow* modelStack, int offset, int yDisplay) {
	...
	if (newLength > MAX_SEQUENCE_LENGTH) {
		return;
	}
...
void AutomationClipView::reportMPEInitialValuesForNoteEditing(ModelStackWithNoteRow* modelStack,
...
void AutomationClipView::reportMPEValueForNoteEditing(int whichExpressionimension, int32_t value) {
...
void AutomationClipView::reportNoteOffForMPEEditing(ModelStackWithNoteRow* modelStack) {
