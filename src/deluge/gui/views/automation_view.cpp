...
PLACE_SDRAM_RODATA constexpr std::array<std::pair<params::Kind, ParamType>, kNumNonGlobalParamsForAutomation>
...
PLACE_SDRAM_RODATA constexpr std::array<std::pair<params::Kind, ParamType>, kNumGlobalParamsForAutomation>
