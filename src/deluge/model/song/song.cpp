...
bool Song::doesNonAudioSlotHaveActiveClipInSession(InstrumentType instrumentType, int slot, int subSlot) {
...
int Song::addInstrumentsToFileItems(InstrumentType instrumentType) {
