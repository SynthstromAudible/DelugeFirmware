...
public:
	...
	void writeParamAsAttribute(StorageManager& writer, char const* name, int32_t p, bool writeAutomation,
...
public:
	...
	int32_t knobPosToParamValue(int32_t knobPos, ModelStackWithAutoParam* modelStack) override;
	int32_t paramValueToKnobPos(int32_t paramValue, ModelStackWithAutoParam* modelStack) override;
	bool writeToFile(StorageManager& writer, bool mustWriteOpeningTagEndFirst = false);
