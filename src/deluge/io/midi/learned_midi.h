...
public:
	...
	void writeToFile(StorageManager& writer, char const* commandName,
	...
	inline void writeNoteToFile(StorageManager& writer, char const* commandName) {
		writeToFile(writer, commandName, MIDI_MESSAGE_NOTE);
	}
	inline void writeCCToFile(StorageManager& writer, char const* commandName) {
		writeToFile(writer, commandName, MIDI_MESSAGE_CC);
	}
	inline void writeChannelToFile(StorageManager& writer, char const* commandName) {
