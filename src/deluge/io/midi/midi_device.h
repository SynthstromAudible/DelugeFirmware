...
public:
	...
	void writeToFile(StorageManager& writer, char const* tagName);
...
public:
	MIDIDevice();
	void writeReferenceToFile(StorageManager& writer, char const* tagName = "device");
	...
	void sendAllMCMs();
	bool worthWritingToFile();
	void writePorts(StorageManager& writer);
...
public:
	MIDIDeviceUSBHosted() {}
	void writeReferenceAttributesToFile(StorageManager& writer);
