...
class Oscillator {
	...
	static void applyAmplitude(std::span<q31_t> input_span, std::span<q31_t> output_span, int32_t amplitude,
	                           int32_t amplitude_increment);

public:
	static void renderOsc(OscType type, int32_t amplitude, int32_t* bufferStart, int32_t* bufferEnd, size_t numSamples,
