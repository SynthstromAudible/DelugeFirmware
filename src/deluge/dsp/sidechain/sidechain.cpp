...
SideChain::SideChain() {
	...
	pos = 0;
	attack = getParamFromUserValue(deluge::modulation::params::Param::Static::COMPRESSOR_ATTACK, 7);
	release = getParamFromUserValue(deluge::modulation::params::Param::Static::COMPRESSOR_RELEASE, 28);
