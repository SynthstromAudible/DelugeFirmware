...
int32_t Compressor::getActualReleaseRate() {
    ...
    if (sync == 0) alteredRelease = release;
        ...
        alteredRelease = multiply_32x32_rshift32(release << 13, playbackHandler.getTimePerInternalTickInverse()) >> (9 - sync);
    }
...
prepareForRelease:
        ...
        lastValue = (multiply_32x32_rshift32(envelopeHeight, (2147483647 - getDecay4(8388608 - pos, 23))) << 1) + envelopeOffset; // Goes down slowly at first. Great squishiness
