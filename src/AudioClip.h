...
public:
	...
	SampleRecorder* recorder; // Will be set to NULL right at the end of the loop's recording, even though the SampleRecorder itself will usually persist slightly longer
