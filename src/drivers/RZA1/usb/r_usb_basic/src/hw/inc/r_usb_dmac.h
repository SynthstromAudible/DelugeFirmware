...
void            usb_cstd_Buf2Fifo_DMAX(uint16_t ch_no, usb_utr_t *ptr, uint16_t useport, uint32_t src, uint32_t data_size, uint8_t pipe, uint8_t trans_block_size);

void            usb_cstd_Buf2Fifo_DMA0(usb_utr_t *ptr, uint16_t useport, uint32_t src, uint32_t data_size, uint8_t pipe, uint8_t trans_block_size);
void            usb_cstd_Buf2Fifo_DMA1(usb_utr_t *ptr, uint16_t useport, uint32_t src, uint32_t data_size, uint8_t pipe, uint8_t trans_block_size);
void            usb_cstd_Buf2Fifo_DMA2(usb_utr_t *ptr, uint16_t useport, uint32_t src, uint32_t data_size, uint8_t pipe, uint8_t trans_block_size);
void            usb_cstd_Buf2Fifo_DMA3(usb_utr_t *ptr, uint16_t useport, uint32_t src, uint32_t data_size, uint8_t pipe, uint8_t trans_block_size);
