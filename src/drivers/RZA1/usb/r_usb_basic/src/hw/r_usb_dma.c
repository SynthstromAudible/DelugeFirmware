...
void usb_cstd_buf2dxfifo_start_dma(usb_utr_t *ptr, uint16_t pipe, uint16_t useport)
{
    ...
    if (0u != DmaSize)
    {
        ...
        usb_cstd_Buf2Fifo_DMAX(ch_no, ptr, useport, (uint32_t)(g_p_usb_hstd_data[ip][pipe]), DmaSize, pipe, TransDataBlockSize);
#endif
#if ((USB_CFG_MODE & USB_CFG_PERI) == USB_CFG_PERI)
        usb_cstd_Buf2Fifo_DMAX(ch_no, ptr, useport, (uint32_t)(g_p_usb_pstd_data[pipe]), DmaSize, pipe, TransDataBlockSize);
#endif
    }
    else
    {
...
/***********************************************************************************************************************
 ...
 Return value    : void
 ***********************************************************************************************************************/
void usb_cpu_dxfifo2buf_start_dma0(usb_utr_t *ptr,  uint32_t SourceAddr, uint16_t useport, uint32_t destAddr, uint32_t transfer_size)
{
    uint32_t    chcfg_data;
    uint16_t    ip;
...
#if USE_DMA32
    chcfg_data = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL | USB_DMA_CHCFG_DEM
        | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_0_8 | USB_DMA_CHCFG_DDS_256
        | USB_DMA_CHCFG_SAD | USB_DMA_CHCFG_SDS_256;
#else
    chcfg_data = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL | USB_DMA_CHCFG_DEM
        | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_0_8 | USB_DMA_CHCFG_DDS_8
        | USB_DMA_CHCFG_SAD | USB_DMA_CHCFG_SDS_8;
#endif
...
/***********************************************************************************************************************
 ...
 Return value    : void
 ***********************************************************************************************************************/
void usb_cpu_dxfifo2buf_start_dma1(usb_utr_t *ptr, uint32_t SourceAddr, uint16_t useport, uint32_t destAddr, uint32_t transfer_size)
{
    uint32_t    chcfg_data;
    uint16_t    ip;
...
#if USE_DMA32
    chcfg_data = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL | USB_DMA_CHCFG_DEM
        | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_1_9 | USB_DMA_CHCFG_DDS_256
        | USB_DMA_CHCFG_SAD | USB_DMA_CHCFG_SDS_256;
#else
    chcfg_data = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL | USB_DMA_CHCFG_DEM
        | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_1_9 | USB_DMA_CHCFG_DDS_8
        | USB_DMA_CHCFG_SAD | USB_DMA_CHCFG_SDS_8;
#endif
...
/***********************************************************************************************************************
 ...
 Return value    : void
 ***********************************************************************************************************************/
void usb_cpu_dxfifo2buf_start_dma2(usb_utr_t *ptr, uint32_t SourceAddr, uint16_t useport, uint32_t destAddr, uint32_t transfer_size)
{
    uint32_t    chcfg_data;
    uint16_t    ip;
...
#if USE_DMA32
    chcfg_data = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL | USB_DMA_CHCFG_DEM
        | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_2_10 | USB_DMA_CHCFG_DDS_256
        | USB_DMA_CHCFG_SAD | USB_DMA_CHCFG_SDS_256;
#else
    chcfg_data = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL | USB_DMA_CHCFG_DEM
        | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_2_10 | USB_DMA_CHCFG_DDS_8
        | USB_DMA_CHCFG_SAD | USB_DMA_CHCFG_SDS_8;
#endif
...
/***********************************************************************************************************************
 ...
 Return value    : void
 ***********************************************************************************************************************/
void usb_cpu_dxfifo2buf_start_dma3(usb_utr_t *ptr, uint32_t SourceAddr, uint16_t useport, uint32_t destAddr, uint32_t transfer_size)
{
    uint32_t    chcfg_data;
    uint16_t    ip;
...
#if USE_DMA32
    chcfg_data = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL | USB_DMA_CHCFG_DEM
        | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_3_11 | USB_DMA_CHCFG_DDS_256
        | USB_DMA_CHCFG_SAD | USB_DMA_CHCFG_SDS_256;
#else
    chcfg_data = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL | USB_DMA_CHCFG_DEM
        | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_3_11 | USB_DMA_CHCFG_DDS_8
        | USB_DMA_CHCFG_SAD | USB_DMA_CHCFG_SDS_8;
#endif
...
/***********************************************************************************************************************
 ...
 Return value    : void
 ***********************************************************************************************************************/
void usb_cpu_dxfifo2buf_start_dmaX(usb_utr_t *ptr, uint16_t ch_no, uint32_t SourceAddr, uint16_t useport, uint32_t destAddr, uint32_t transfer_size)
{
    switch(ch_no)
    {
        case USB_CFG_CH0:
...
/***********************************************************************************************************************
 ...
 Return value    : void
 ***********************************************************************************************************************/
void usb_cpu_buf2dxfifo_start_dma0(uint16_t useport, uint32_t src_adr, uint16_t ip, uint32_t transfer_size, uint8_t trans_block_size)
{
    ...
    {
        DMAC0.CHCFG_n = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL
            | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_0_8 | USB_DMA_CHCFG_DDS_8
            | USB_DMA_CHCFG_DAD | USB_DMA_CHCFG_SDS_8 | USB_DMA_CHCFG_REQD;
    }
    else if (4u == trans_block_size)
    {
        DMAC0.CHCFG_n = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL
            | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_0_8 | USB_DMA_CHCFG_DDS_32
            | USB_DMA_CHCFG_DAD | USB_DMA_CHCFG_SDS_32 | USB_DMA_CHCFG_REQD;
    }else if (32u == trans_block_size)
    {
        DMAC0.CHCFG_n = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL
            | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_0_8 | USB_DMA_CHCFG_DDS_256
            | USB_DMA_CHCFG_DAD | USB_DMA_CHCFG_SDS_256 | USB_DMA_CHCFG_REQD;
    }
...
/***********************************************************************************************************************
 ...
 Return value    : void
 ***********************************************************************************************************************/
void usb_cpu_buf2dxfifo_start_dma1(uint16_t useport, uint32_t src_adr, uint16_t ip, uint32_t transfer_size, uint8_t trans_block_size)
{
    ...
    if (1u == trans_block_size)
    {
        DMAC1.CHCFG_n = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL
            | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_1_9 | USB_DMA_CHCFG_DDS_8
            | USB_DMA_CHCFG_DAD | USB_DMA_CHCFG_SDS_8 | USB_DMA_CHCFG_REQD;
    }
    else if (4u == trans_block_size)
    {
        DMAC1.CHCFG_n = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL
            | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_1_9 | USB_DMA_CHCFG_DDS_32
            | USB_DMA_CHCFG_DAD | USB_DMA_CHCFG_SDS_32 | USB_DMA_CHCFG_REQD;
    }
    else if (32u == trans_block_size)
    {
...
/***********************************************************************************************************************
 ...
 Return value    : void
 ***********************************************************************************************************************/
void usb_cpu_buf2d1fifo_start_dma2(uint16_t useport, uint32_t src_adr, uint16_t ip, uint32_t transfer_size, uint8_t trans_block_size)
{
    ...
    if (1u == trans_block_size)
    {
        DMAC2.CHCFG_n = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL
            | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_2_10 | USB_DMA_CHCFG_DDS_8
            | USB_DMA_CHCFG_DAD | USB_DMA_CHCFG_SDS_8 | USB_DMA_CHCFG_REQD;
    }
    else if (4u == trans_block_size)
    {
        DMAC2.CHCFG_n = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL
            | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_2_10 | USB_DMA_CHCFG_DDS_32
            | USB_DMA_CHCFG_DAD | USB_DMA_CHCFG_SDS_32 | USB_DMA_CHCFG_REQD;
    }
    else if (32u == trans_block_size)
    {
...
/***********************************************************************************************************************
 ...
 Return value    : void
 ***********************************************************************************************************************/
void usb_cpu_buf2d1fifo_start_dma3(uint16_t useport,  uint32_t src_adr, uint16_t ip, uint32_t transfer_size, uint8_t trans_block_size)
{
    ...
    if (1u == trans_block_size)
    {
        DMAC3.CHCFG_n = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL
            | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_3_11 | USB_DMA_CHCFG_DDS_8
            | USB_DMA_CHCFG_DAD | USB_DMA_CHCFG_SDS_8 | USB_DMA_CHCFG_REQD;
    }
    else if (4u == trans_block_size)
    {
        DMAC3.CHCFG_n = USB_DMA_CHCFG_AM_BCM | USB_DMA_CHCFG_LVL
            | USB_DMA_CHCFG_HIEN |USB_DMA_CHCFG_SEL_3_11 | USB_DMA_CHCFG_DDS_32
            | USB_DMA_CHCFG_DAD | USB_DMA_CHCFG_SDS_32 | USB_DMA_CHCFG_REQD;
    }
    else if (32u == trans_block_size)
    {
...
/***********************************************************************************************************************
 ...
 Return value    : none
 ***********************************************************************************************************************/
void usb_cstd_Buf2Fifo_DMA0(usb_utr_t *ptr, uint16_t useport, uint32_t src, uint32_t data_size, uint8_t pipe,
...
/***********************************************************************************************************************
 ...
 Return value    : none
 ***********************************************************************************************************************/
void usb_cstd_Buf2Fifo_DMA1(usb_utr_t *ptr, uint16_t useport, uint32_t src, uint32_t data_size, uint8_t pipe,
                            uint8_t trans_block_size)
{
    uint16_t    bcfg_setting;
    uint16_t    mbw_setting;
...
/***********************************************************************************************************************
 ...
 Return value    : none
 ***********************************************************************************************************************/
void usb_cstd_Buf2Fifo_DMA2(usb_utr_t *ptr, uint16_t useport, uint32_t src, uint32_t data_size, uint8_t pipe,
                            uint8_t trans_block_size)
{
    uint16_t    bcfg_setting;
    uint16_t    mbw_setting;
...
/***********************************************************************************************************************
 ...
 Return value    : none
 ***********************************************************************************************************************/
void usb_cstd_Buf2Fifo_DMA3(usb_utr_t *ptr, uint16_t useport, uint32_t src, uint32_t data_size, uint8_t pipe,
                            uint8_t trans_block_size)
{
    uint16_t    bcfg_setting;
    uint16_t    mbw_setting;
